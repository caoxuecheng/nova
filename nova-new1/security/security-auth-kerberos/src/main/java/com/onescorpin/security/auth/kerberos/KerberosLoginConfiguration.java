package com.onescorpin.security.auth.kerberos;

/*-
 * #%L
 * onescorpin-security-auth-kerberos
 * %%
...
public class KerberosLoginConfiguration {
    ...
    @Value("${security.auth.krb.login.order:#{T(com.onescorpin.auth.jaas.LoginConfiguration).DEFAULT_ORDER}}")
