...
public class DefaultLoginConfigurationBuilder implements LoginConfigurationBuilder {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.LoginConfigurationBuilder#order(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.LoginConfigurationBuilder#loginModule(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.LoginConfigurationBuilder#build()
     */
    @Override
