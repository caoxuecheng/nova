package com.onescorpin.auth.jwt;
...
import com.onescorpin.auth.config.JwtProperties;
...
public class JwtRememberMeServicesTest {
    ...
    public void setUp() {
        ...
        properties.setKey("https://www.onescorpin.com/");
    ...
    public void onLoginSuccess() throws Exception {
        ...
        final Authentication auth = new UsernamePasswordAuthenticationToken("dladmin", "onescorpin", Collections.singletonList(new SimpleGrantedAuthority("admin")));
