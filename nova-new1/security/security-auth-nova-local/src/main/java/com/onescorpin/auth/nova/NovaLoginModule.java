...
/**
 * A login module that authenticates users using the Nova user store.  By default
 ...
 */
public class NovaLoginModule extends AbstractLoginModule implements LoginModule {
