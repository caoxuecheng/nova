...
public class ImmutableAllowedActions implements AllowedActions {
    ...
    /* (non-Javadoc)
         * @see com.onescorpin.security.action.AllowedActions#checkPermission(java.util.Set)
         */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#checkPermission(com.onescorpin.security.action.Action, com.onescorpin.security.action.Action[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#enable(java.security.Principal, com.onescorpin.security.action.Action, com.onescorpin.security.action.Action[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#enable(java.security.Principal, java.util.Set)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#enableOnly(java.security.Principal, com.onescorpin.security.action.Action, com.onescorpin.security.action.Action[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#enableOnly(java.security.Principal, java.util.Set)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#disable(java.security.Principal, com.onescorpin.security.action.Action, com.onescorpin.security.action.Action[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowedActions#disable(java.security.Principal, java.util.Set)
     */
    @Override
