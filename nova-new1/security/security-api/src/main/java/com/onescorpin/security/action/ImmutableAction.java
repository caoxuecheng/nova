 ...
 *
 */
package com.onescorpin.security.action;

/*-
 * #%L
 * onescorpin-security-api
 * %%
...
public class ImmutableAction implements Action {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.Action#subAction(java.lang.String, java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.Action#getTitle()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.Action#getDescription()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.Action#getHierarchy()
     */
