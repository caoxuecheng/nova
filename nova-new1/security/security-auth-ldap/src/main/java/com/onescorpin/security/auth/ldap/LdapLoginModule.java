 ...
 *
 */
package com.onescorpin.security.auth.ldap;

/*-
 * #%L
 * onescorpin-security-auth-ldap
 * %%
...
public class LdapLoginModule extends AbstractLoginModule {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.AbstractLoginModule#initialize(javax.security.auth.Subject, javax.security.auth.callback.CallbackHandler, java.util.Map, java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.AbstractLoginModule#doLogin()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.AbstractLoginModule#doCommit()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.AbstractLoginModule#doAbort()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.auth.jaas.AbstractLoginModule#doLogout()
     */
    @Override
