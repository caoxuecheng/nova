...
import com.onescorpin.discovery.FileParserFactory;
 ...
 */
@Api(tags = "Nflow Manager - Schema Discovery", produces = "application/json")
@Path("/v1/schema-discovery")
@SwaggerDefinition(tags = @Tag(name = "Nflow Manager - Schema Discovery", description = "determine file schemas"))
public class SchemaDiscoveryRestController {
    ...
    private static final ResourceBundle STRINGS = ResourceBundle.getBundle("com.onescorpin.discovery.rest.controller.DiscoveryMessages");
