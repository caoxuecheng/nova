...
public class Datasource implements com.onescorpin.metadata.datasource.Datasource {
     ...
     */
    public Datasource(@Nonnull final com.onescorpin.metadata.datasource.Datasource other) {
        setId(other.getId());
