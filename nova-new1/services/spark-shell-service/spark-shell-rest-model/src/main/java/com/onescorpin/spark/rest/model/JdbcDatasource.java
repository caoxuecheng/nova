package com.onescorpin.spark.rest.model;
 ...
 */
public class JdbcDatasource extends UserDatasource implements com.onescorpin.metadata.datasource.JdbcDatasource {
     ...
     */
    public JdbcDatasource(@Nonnull final com.onescorpin.metadata.datasource.JdbcDatasource other) {
        super(other);
