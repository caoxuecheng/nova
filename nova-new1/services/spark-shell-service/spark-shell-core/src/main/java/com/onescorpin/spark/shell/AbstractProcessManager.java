...
import com.onescorpin.spark.conf.model.KerberosSparkProperties;
import com.onescorpin.spark.conf.model.SparkShellProperties;
import com.onescorpin.spark.rest.model.RegistrationRequest;
import com.onescorpin.spark.shell.cluster.SparkShellClusterDelegate;
...
/**
 * Manages multiple Nova Spark Shell processes.
 *
 * <p>A unique username and password is generated for each process to communicate with the Nova Services process.</p>
 */
public abstract class AbstractProcessManager implements ApplicationRunner, SparkShellClusterDelegate, SparkShellProcessListener, SparkShellProcessManager {
    ...
    /**
     * Nova Spark Shell client configuration
     */
    @Nonnull
    ...
    /**
     * System Nova Spark Shell process
     */
    @Nullable
     ...
     *
     * @param sparkShellProperties the Nova Spark Shell client configuration
     * @param kerberosProperties   the Kerberos configuration for the Nova Spark Shell client
    ...
    public SparkShellProcess getProcessForUser(@Nonnull final String username) throws InterruptedException {
        ...
        throw new IllegalStateException("Failed to start Nova Spark Shell service");
    }
