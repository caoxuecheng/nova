package com.onescorpin.spark.shell.cluster;
...
import com.onescorpin.spark.shell.SparkShellProcessListener;
...
/**
 * Coordinates Spark Shell processes between Nova nodes in a cluster.
 */
public class SparkShellClusterListener implements ClusterServiceListener, ClusterServiceMessageReceiver, SparkShellProcessListener {
     ...
     *
     * @param clusterService the Nova cluster service
