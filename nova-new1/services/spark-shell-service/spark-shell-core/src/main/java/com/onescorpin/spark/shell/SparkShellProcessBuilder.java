...
import com.onescorpin.spark.shell.locator.CodeSourceAppLocator;
import com.onescorpin.spark.shell.locator.EnvironmentAppLocator;
...
public class SparkShellProcessBuilder {
     ...
     */
    private static final String CLIENT_ID = "NOVA_CLIENT_ID";

    /**
     * Name of the client secret environment variable
     */
    private static final String CLIENT_SECRET = "NOVA_CLIENT_SECRET";
    ...
    public SparkShellProcessBuilder() {
        ...
        launcher = new SparkLauncher(env)
            ...
            .setMainClass("com.onescorpin.spark.SparkShellApp");
    }
    ...
    /**
     * Determines the location of the nova-spark-shell-client jar.
     *
     * @throws IllegalStateException if the jar cannot be located
     */
    String getAppResource() {
        if (appResource == null) {
            final String resourceName = "nova-spark-shell-client-v" + getSparkVersion() + "-" + NovaVersionUtil.getBuildVersion() + ".jar";
            appResource = Stream.of(new EnvironmentAppLocator(), new CodeSourceAppLocator())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalStateException("Unable to find the Nova Spark Shell Client app. Either set it explicitly or use the NOVA_SERVICES_HOME environment variable."));
        }
        return appResource;
    }
