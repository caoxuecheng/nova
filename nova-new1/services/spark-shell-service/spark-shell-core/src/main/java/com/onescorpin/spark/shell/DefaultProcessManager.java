...
/**
 * Manages a single Nova Spark Shell process that is shared across multiple users.
 */
public class DefaultProcessManager extends AbstractProcessManager {

    /**
     * The Nova Spark Shell process
     */
    @Nullable
     ...
     *
     * @param properties         the Nova Spark Shell configuration
