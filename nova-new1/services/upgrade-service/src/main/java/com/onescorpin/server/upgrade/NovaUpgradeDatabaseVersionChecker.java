...
public class NovaUpgradeDatabaseVersionChecker {

    private static final Logger log = LoggerFactory.getLogger(NovaUpgradeDatabaseVersionChecker.class);
    ...
    public NovaUpgradeDatabaseVersionChecker() {

    }

    /**
     * Query the Database for the Nova Version
     *
     * @return the NovaVersion from the database, or null if not found or if an error occurs
     */
    public NovaVersion getDatabaseVersion() {
        NovaVersion version = null;
        ...
        try {
            ...
            String query = "SELECT * FROM NOVA_VERSION ORDER BY MAJOR_VERSION DESC, MINOR_VERSION DESC, POINT_VERSION DESC, TAG DESC";
            ...
            if (rs.next()) {
                ...
                version = new NovaVersionUtil.Version(majorVersion, minorVersion, pointVersion, tag);
            }
