package com.onescorpin.scheduler.rest;

/*-
 * #%L
 * onescorpin-scheduler-controller
 * %%
...
import com.onescorpin.scheduler.JobInfo;
...
import com.onescorpin.scheduler.model.DefaultTriggerInfo;
import com.onescorpin.scheduler.rest.model.ScheduleIdentifier;
import com.onescorpin.scheduler.rest.model.ScheduledJob;
import com.onescorpin.scheduler.rest.model.TriggerInfo;
import com.onescorpin.scheduler.support.ScheduledJobState;
...
public class Model {
    ...
    public static final Function<TriggerInfo, com.onescorpin.scheduler.model.DefaultTriggerInfo>
    ...
    public static final Function<com.onescorpin.scheduler.TriggerInfo, TriggerInfo>
        DOMAIN_TO_TRIGGER_INFO =
        new Function<com.onescorpin.scheduler.TriggerInfo, TriggerInfo>() {
            @Override
            public TriggerInfo apply(com.onescorpin.scheduler.TriggerInfo domain) {
    ...
    public static List<TriggerInfo> domainToTriggerInfo(Collection<com.onescorpin.scheduler.TriggerInfo> triggerInfos) {
