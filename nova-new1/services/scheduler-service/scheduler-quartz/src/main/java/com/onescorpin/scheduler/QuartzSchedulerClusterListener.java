        ...
        Resource resource = new ClassPathResource("quartz.properties");
            if (resource.exists()) {
                try {
                    ...
                    if(!isValid) {
                        log.error("Nova is running in clustered mode by Quartz scheduler is not configured for clustered mode.  Please ensure the Quartz is configured for database persistence in clustered mode ");
                    }
                } catch (IOException e) {
                    log.error("Nova is running in Clustered mode the system cannot find the 'quartz.properties' file.  Please ensure the Quartz is configured for database persistence in clustered mode", e);
                }
            } else {
                log.error("Nova is running in Clustered mode the system cannot find the 'quartz.properties' file. Please ensure the Quartz is configured for database persistence in clustered mode");
            }
