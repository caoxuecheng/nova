...
/**
 * Provides access to Nova users and groups.
 */
public interface UserService {

    /**
     * Deletes the specified group from Nova.
     *
    ...
    /**
     * Deletes the specified user from Nova.
     *
    ...
    /**
     * Gets a list of all groups in Nova.
     *
     * @return all groups
     */
    @Nonnull
    ...
    /**
     * Gets a list of all users in Nova.
     *
     * @return all users
     */
    @Nonnull
