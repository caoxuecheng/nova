...
public class UserModelTransform {
     ...
     */
    @Nonnull
    public static Function<com.onescorpin.metadata.api.user.UserGroup, UserGroup> toGroupPrincipal() {
        return (com.onescorpin.metadata.api.user.UserGroup group) -> {
     ...
     */
    @Nonnull
    public static Function<com.onescorpin.metadata.api.user.User, User> toUserPrincipal() {
        return (com.onescorpin.metadata.api.user.User domain) -> {
            ...
            principal.setGroups(domain.getGroups().stream()
                                    .map(com.onescorpin.metadata.api.user.UserGroup::getSystemName)
