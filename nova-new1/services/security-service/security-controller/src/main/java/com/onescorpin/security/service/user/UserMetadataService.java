package com.onescorpin.security.service.user;
...
/**
 * Provides access to Nova users and groups stored in the metadata store.
 */
public class UserMetadataService implements UserService {
    ...
    public void updateGroup(@Nonnull final UserGroup group) {
        metadataAccess.commit(() -> {
            ...
            final com.onescorpin.metadata.api.user.UserGroup domain = userProvider.findGroupByName(group.getSystemName())
    ...
    public void updateUser(@Nonnull final User user) {
        metadataAccess.commit(() -> {
            ...
            final com.onescorpin.metadata.api.user.User domain = userProvider.findUserBySystemName(user.getSystemName())
            ...
            final Set<com.onescorpin.metadata.api.user.UserGroup> groups = user.getGroups().stream()
