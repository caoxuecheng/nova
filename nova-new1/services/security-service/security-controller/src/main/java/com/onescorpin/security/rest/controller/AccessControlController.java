...
public class AccessControlController {
    ...
    private Set<Action> collectActions(PermissionsChange changes) {
        ...
        for (com.onescorpin.security.rest.model.Action modelAction : changes.getActionSet().getActions()) {
     ...
     */
    private void loadActionSet(com.onescorpin.security.rest.model.Action modelAction, Action action, Set<Action> set) {
        if (modelAction.getActions().isEmpty()) {
            set.add(action);
        } else {
            for (com.onescorpin.security.rest.model.Action modelChild : modelAction.getActions()) {
