...
public class DataOperation {
    ...
    private String nflowDestinationId;

    public String getNflowDestinationId() {
        return nflowDestinationId;
    }

    public void setNflowDestinationId(String nflowDestinationId) {
        this.nflowDestinationId = nflowDestinationId;
    }
