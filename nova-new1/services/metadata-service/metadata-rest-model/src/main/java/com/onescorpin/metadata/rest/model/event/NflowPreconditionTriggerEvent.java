...
public class NflowPreconditionTriggerEvent implements Serializable {
    ...
    public NflowPreconditionTriggerEvent() {
    }

    public NflowPreconditionTriggerEvent(String id) {
        this.nflowId = id;
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + ": " + (this.nflowId != null ? this.nflowId : this.category + "." + this.nflowName);
    }
}
