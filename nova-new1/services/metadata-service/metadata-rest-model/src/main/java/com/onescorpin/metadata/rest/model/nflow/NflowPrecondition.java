...
public class NflowPrecondition implements Serializable {

    private ServiceLevelAgreement sla;

    public NflowPrecondition() {
        this("Nflow preconditon");
    }

    public NflowPrecondition(String name) {
        super();
        this.sla = new ServiceLevelAgreement("Nflow " + name + " precondition");
    }

    public NflowPrecondition(String name, String description, List<Metric> metrics) {
        this(name);
