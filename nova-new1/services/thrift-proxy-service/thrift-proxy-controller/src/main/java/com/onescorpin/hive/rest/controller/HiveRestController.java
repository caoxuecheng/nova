package com.onescorpin.hive.rest.controller;

/*-
 * #%L
 * onescorpin-thrift-proxy-controller
 * %%
...
import com.onescorpin.discovery.schema.DatabaseMetadata;
import com.onescorpin.discovery.schema.QueryResult;
import com.onescorpin.discovery.schema.TableSchema;
import com.onescorpin.hive.service.HiveMetastoreService;
...
@Api(tags = "Nflow Manager - Tables", produces = "application/json")
@Path(HiveRestController.BASE)
@SwaggerDefinition(tags = @Tag(name = "Nflow Manager - Tables", description = "access to Hive tables"))
