package com.onescorpin.alerts.rest.controller;

/*-
 * #%L
 * onescorpin-alerts-controller
 * %%
...
import com.onescorpin.alerts.api.core.AggregatingAlertProvider;
import com.onescorpin.alerts.api.core.AlertCriteriaInput;
import com.onescorpin.alerts.rest.AlertsModel;
import com.onescorpin.alerts.rest.model.AlertCreateRequest;
import com.onescorpin.alerts.rest.model.AlertRange;
import com.onescorpin.alerts.rest.model.AlertSummaryGrouped;
import com.onescorpin.alerts.rest.model.AlertType;
import com.onescorpin.alerts.rest.model.AlertUpdateRequest;
...
public class AlertsController {
    ...
    public Set<AlertType> getAlertTypes(@QueryParam("type") String type,
                                                             @QueryParam("subtype") String subtype) {
      Set<String> alertTypes =((NovaEntityAwareAlertManager)alertManager).getAlertTypes();
    ...
    @ApiResponses({
                      @ApiResponse(code = 200, message = "Returns the alert.", response = com.onescorpin.alerts.rest.model.Alert.class),
                      @ApiResponse(code = 404, message = "The alert could not be found.", response = RestResponseStatus.class)
                  })
    public com.onescorpin.alerts.rest.model.Alert getAlert(@PathParam("id") String idStr) {
    ...
    public com.onescorpin.alerts.rest.model.Alert createAlert(AlertCreateRequest req) {
    ...
    public com.onescorpin.alerts.rest.model.Alert updateAlert(@PathParam("id") String idStr,
