package com.onescorpin.alerts.rest.model;
...
public class AlertSummaryGrouped {
    ...
    public static class Builder {
        ...
        public Builder nflowId(String nflowId){
            this.nflowId = nflowId;
            return this;
        }

        public Builder nflowName(String nflowName){
        ...
        public AlertSummaryGrouped build(){
            ...
            alertSummary.setNflowName(this.nflowName);
            alertSummary.setNflowId(this.nflowId);
            alertSummary.setSlaId(this.slaId);
            alertSummary.setSlaName(this.slaName);
            if(StringUtils.isNotBlank(this.nflowName)){
                alertSummary.setGroupDisplayName(this.nflowName);
            }
