package com.onescorpin.config.rest.controller;
...
@SwaggerDefinition(tags = @Tag(name = "Configuration", description = "information on Nova"))
public class ConfigurationController {
    ...
    @ApiOperation("Gets the current Nova configuration.")
    @ApiResponses({
    ...
    public Response moduleUrls() {
        ...
        map.put("nflowMgr", url + "/nflow-mgr/index.html");
