...
import com.onescorpin.rest.SpringJerseyConfiguration;
...
@ComponentScan("com.onescorpin")
public class NovaServerApplication implements SchedulingConfigurer {

    private static final Logger log = LoggerFactory.getLogger(NovaServerApplication.class);

    public static void main(String[] args) {
        SLF4JBridgeHandler.install();
        NovaUpgrader upgrader = new NovaUpgrader();

        if (upgrader.isUpgradeRequired()) {
            NovaVersion currentVersion = upgrader.getCurrentVersion();
            ...
            log.info("Nova v{} is up to date.  Starting the application.",NovaVersionUtil.getBuildVersion());
        }
