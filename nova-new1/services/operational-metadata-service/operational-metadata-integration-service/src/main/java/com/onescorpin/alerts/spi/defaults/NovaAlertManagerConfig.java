 ...
 */
@Configuration
public class NovaAlertManagerConfig {

    @Bean(name = "novaAlertManager")
    public NovaEntityAwareAlertManager novaAlertManager(JpaAlertRepository repo, AlertSourceAggregator aggregator) {
        NovaEntityAwareAlertManager mgr = new NovaEntityAwareAlertManager(repo);
