package com.onescorpin.jms;

/*-
 * #%L
 * nova-jms-service-api
 * %%
...
@Configuration
@EnableJms
@ComponentScan(basePackages = {"com.onescorpin.jms"})
@PropertySources({
                     @PropertySource(value = "file:${nova.nifi.configPath}/config.properties", ignoreResourceNotFound = true),
...
public class JmsConfig {
    ...
    public JmsListenerContainerFactory<?> jmsContainerFactory(ConnectionFactory connectionFactory) {
        ...
        factory.setClientId(env.getProperty("jms.client.id:onescorpin.nflowmgr"));
