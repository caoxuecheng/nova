...
/**
 * Transforms user-defined properties between Nflow Manager and Metadata formats.
 */
public final class UserPropertyTransform {
    ...
    /**
     * Transforms the specified Metadata user-defined properties to Nflow Manager user-defined properties.
     *
     * @param properties map of property names to values
     * @param userFields the user-defined field descriptors
     * @return the set of Nflow Manager user-defined properties
     */
    @Nonnull
    @SafeVarargs
    public static Set<UserProperty> toUserProperties(@Nonnull final Map<String, String> properties, @Nonnull final Set<UserFieldDescriptor>... userFields) {
        ...
        // Convert from Metadata to Nflow Manager format
        ...
        final Stream<UserProperty> existingProperties = properties.entrySet().stream()
            .map(entry -> {
                // Create the Nflow Manager property
                final UserProperty property = new UserProperty();
                ...
                // Return the Nflow Manager property
                return property;
            });
    ...
    /**
     * Transforms the specified Nflow Manager user-defined properties to Metadata user-defined properties.
     *
     * @param userProperties the Nflow Manager user-defined properties
    ...
    public static Set<UserFieldDescriptor> toUserFieldDescriptors(@Nonnull final Set<UserField> userFields) {
        return userFields.stream().map(NflowManagerUserFieldDescriptor::new).collect(Collectors.toSet());
    }
     ...
     */
    private static class NflowManagerUserFieldDescriptor implements UserFieldDescriptor {
        ...
        /**
         * Constructs a {@code NflowManagerUserFieldDescriptor} that delegates to the specified user-defined field.
         *
         * @param userField the user-defined field to delegate to
         */
        NflowManagerUserFieldDescriptor(@Nonnull final UserField userField) {
