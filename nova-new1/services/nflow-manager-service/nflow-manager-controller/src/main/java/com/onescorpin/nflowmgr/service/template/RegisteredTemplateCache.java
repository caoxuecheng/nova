...
/**
 * Cache to store processor data to speed up saving of nflows when applying the derived datasources
 * @see com.onescorpin.nflowmgr.service.nflow.datasource.DerivedDatasourceFactory
 */
