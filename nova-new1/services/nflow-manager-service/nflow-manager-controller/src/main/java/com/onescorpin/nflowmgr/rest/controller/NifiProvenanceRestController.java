...
import com.onescorpin.nflowmgr.nifi.cache.CacheSummary;
...
/**
 * Used by the NiFi NovaProvenanceEventReportingTask. Provides information about the flows and the max event id processed by Nova.
 */
...
public class NifiProvenanceRestController {
    ...
    public Response resetCache() {
       boolean updated = nifiFlowCache.rebuildAll();
        return Response.ok(updated ?"Reset the Cache" :" Unable to reset the cache.  Refer to the nova-services.log file for more information.").build();
    }
