...
/**
 */
public interface NflowManagerTemplateService {
    ...
    /**
     * change the state of the template to be {@link com.onescorpin.metadata.api.template.NflowManagerTemplate.State#ENABLED}
     *
    ...
    /**
     * change the state of the template to be {@link com.onescorpin.metadata.api.template.NflowManagerTemplate.State#DISABLED}
     *
     * @param templateId the template id
     * @return the updated template
     */
     ...
     */
    Set<PortDTO> getReusableNflowInputPorts();
