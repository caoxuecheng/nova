...
import com.onescorpin.nifi.rest.client.layout.ProcessGroupAndConnections;
...
import com.onescorpin.nifi.rest.support.NifiTemplateNameUtil;
 ...
 */
public class CleanupStaleNflowRevisions {

    private static final Logger log = LoggerFactory.getLogger(CleanupStaleNflowRevisions.class);
     ...
     */
    public CleanupStaleNflowRevisions(LegacyNifiRestClient restClient, String processGroupId, NiFiPropertyDescriptorTransform propertyDescriptorTransform) {
    ...
    /**
     * Cleanup all versioned nflow process groups
