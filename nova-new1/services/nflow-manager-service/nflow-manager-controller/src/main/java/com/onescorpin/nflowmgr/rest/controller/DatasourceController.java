...
import com.onescorpin.nflowmgr.nifi.controllerservice.DBCPConnectionPoolService;
...
@Api(tags = "Nflow Manager - Data Sources", produces = "application/json")
@Component
@Path("/v1/metadata/datasource")
@SwaggerDefinition(tags = @Tag(name = "Nflow Manager - Data Sources", description = "manages data sources"))
public class DatasourceController {
    ...
    public List<Datasource> getDatasources(@QueryParam(DatasourceCriteria.NAME) final String name,
        ...
        return this.metadata.read(() -> {
            ...
            com.onescorpin.metadata.api.datasource.DatasourceCriteria criteria = createDatasourceCriteria(name, owner, on, after, before, type);
    ...
    public Datasource postDatasource(@Nonnull final UserDatasource datasource) {
        return metadata.commit(() -> {
            accessController.checkPermission(AccessController.SERVICES, NflowServicesAccessControl.EDIT_DATASOURCES);
    ...
    public Datasource getDatasource(@PathParam("id") String idStr, @QueryParam("sensitive") boolean sensitive) {
        return this.metadata.read(() -> {
            // Check permissions
            accessController.checkPermission(AccessController.SERVICES, sensitive ? NflowServicesAccessControl.ADMIN_DATASOURCES : NflowServicesAccessControl.ACCESS_DATASOURCES);

            com.onescorpin.metadata.api.datasource.Datasource.ID id = this.datasetProvider.resolve(idStr);
            com.onescorpin.metadata.api.datasource.Datasource ds = this.datasetProvider.getDatasource(id);
    ...
    public void deleteDatasource(@PathParam("id") final String idStr) {
        metadata.commit(() -> {
            final com.onescorpin.metadata.api.datasource.Datasource.ID id = datasetProvider.resolve(idStr);
            final com.onescorpin.metadata.api.datasource.Datasource datasource = datasetProvider.getDatasource(id);
            if (datasource == null) {
                throw new NotFoundException("No datasource exists with the given ID: " + idStr);
            }
            if (datasource instanceof com.onescorpin.metadata.api.datasource.UserDatasource) {
                final com.onescorpin.metadata.api.datasource.UserDatasource userDatasource = (com.onescorpin.metadata.api.datasource.UserDatasource) datasource;
    ...
    public Set<DatasourceDefinition> getDatasourceDefinitions() {
        return this.metadata.read(() -> {
            ...
            Set<com.onescorpin.metadata.api.datasource.DatasourceDefinition> datasourceDefinitions = this.datasourceDefinitionProvider.getDatasourceDefinitions();
    ...
    public Response getTableNames(@PathParam("id") final String idStr, @QueryParam("schema") final String schema, @QueryParam("tableName") final String tableName) {
        ...
        final Optional<com.onescorpin.metadata.api.datasource.Datasource.ID> id = metadata.read(() -> {
            accessController.checkPermission(AccessController.SERVICES, NflowServicesAccessControl.ACCESS_DATASOURCES);

            final com.onescorpin.metadata.api.datasource.Datasource datasource = datasetProvider.getDatasource(datasetProvider.resolve(idStr));
            return Optional.ofNullable(datasource).map(com.onescorpin.metadata.api.datasource.Datasource::getId);
        });
    ...
    private com.onescorpin.metadata.api.datasource.DatasourceCriteria createDatasourceCriteria(String name,
                                                                                                      String owner,
                                                                                                      String on,
                                                                                                      String after,
                                                                                                      String before,
                                                                                                      String type) {
        com.onescorpin.metadata.api.datasource.DatasourceCriteria criteria = datasetProvider.datasetCriteria();
        ...
        if (StringUtils.isNotEmpty(type)) {
            if ("UserDatasource".equalsIgnoreCase(type)) {
                criteria.type(com.onescorpin.metadata.api.datasource.UserDatasource.class);
            }
        }
