...
import com.onescorpin.nflowmgr.rest.model.NiFiTemplateFlowRequest;
import com.onescorpin.nflowmgr.rest.model.NiFiTemplateFlowResponse;
...
import com.onescorpin.nflowmgr.rest.model.TemplateDtoWrapper;
import com.onescorpin.nflowmgr.rest.model.TemplateOrder;
...
@SwaggerDefinition(tags = @Tag(name = "Nflow Manager - Templates", description = "manages templates"))
public class TemplatesRestController {
    ...
    public static final String BASE = "/v1/nflowmgr/templates";
    ...
    /**
     * This will list all the templates registered in Nova
     */
    @GET
    ...
    public List<RegisteredTemplate.Processor> getReusableTemplateProcessorsForInputPorts(@QueryParam("inputPorts") String inputPortIds) {
        ...
        if (StringUtils.isNotBlank(inputPortIds)) {
            ...
            processorProperties = nflowManagerTemplateService.getReusableTemplateProcessorsForInputPorts(inputPortIdsList);
        }
    ...
    public Response getNiFiTemplateProcessors(@PathParam("templateId") String templateId) {
        List<RegisteredTemplate.Processor> processorProperties = nflowManagerTemplateService.getNiFiTemplateProcessorsWithProperties(templateId);
    ...
    public Response getNiFiTemplateFlowInfo(@PathParam("templateId") String templateId, NiFiTemplateFlowRequest flowRequest) {
        ...
        if (StringUtils.isNotBlank(templateId)) {
            ...
            List<RegisteredTemplate.FlowProcessor> processors = nflowManagerTemplateService.getNiFiTemplateFlowProcessors(templateId, flowRequest.getConnectionInfo());
    ...
    public List<RegisteredTemplate.Processor> getReusableTemplateProcessorsForInputPorts(@PathParam("templateId") String templateId,
        ...
        List<RegisteredTemplate.Processor> processorProperties = nflowManagerTemplateService.getRegisteredTemplateProcessors(templateId, includeReusableTemplates);
    ...
    public Response getRegisteredTemplate(@PathParam("templateId") String templateId, @QueryParam("allProperties") boolean allProperties, @QueryParam("nflowName") String nflowName,
                                          @QueryParam("templateName") String templateName,  @QueryParam("nflowEdit") @DefaultValue("false") boolean nflowEdit) {
        ...
        RegisteredTemplateRequest
            ...
            new RegisteredTemplateRequest.Builder().templateId(templateId).templateName(templateName).nifiTemplateId(templateId).includeAllProperties(allProperties).includePropertyDescriptors(true)
                .isTemplateEdit(!nflowEdit).isNflowEdit(nflowEdit).build();
    ...
    public Response enableTemplate(@PathParam("templateId") String templateId) {
        RegisteredTemplate enabledTemplate = nflowManagerTemplateService.enableTemplate(templateId);
    ...
    public Response disableTemplate(@PathParam("templateId") String templateId) {
        RegisteredTemplate disabledTemplate = nflowManagerTemplateService.disableTemplate(templateId);
    ...
    public Response deleteTemplate(@PathParam("templateId") String templateId) {
        boolean deleted = nflowManagerTemplateService.deleteRegisteredTemplate(templateId);
    ...
    public Response orderTemplates(TemplateOrder templateOrder) {
        nflowManagerTemplateService.orderTemplates(templateOrder.getTemplateIds(), null);
    ...
    public Response registerTemplate(RegisteredTemplate registeredTemplate) {
        ...
        RegisteredTemplate saved = nflowManagerTemplateService.registerTemplate(registeredTemplate);
