package com.onescorpin.nflowmgr.nifi.controllerservice;
...
import com.onescorpin.db.PoolingDataSourceService;
...
import com.onescorpin.nflowmgr.nifi.controllerservice.DescribeTableControllerServiceRequest.DescribeTableControllerServiceRequestBuilder;
import com.onescorpin.nflowmgr.nifi.controllerservice.ExecuteQueryControllerServiceRequest.ExecuteQueryControllerServiceRequestBuilder;
import com.onescorpin.nflowmgr.service.datasource.DatasourceModelTransform;
import com.onescorpin.jdbc.util.DatabaseType;
...
import com.onescorpin.schema.DBSchemaParser;
import com.onescorpin.schema.QueryRunner;
...
/**
 * Allow Nova to use a NiFi database pool connection to display database metadata and execute queries.
 */
@Service
        ...
        if (!valid) {
            List<Datasource> matchingDatasources = metadataAccess.read(() -> {
                ...
                return datasetProvider
                    .getDatasources(datasetProvider.datasetCriteria().type(com.onescorpin.metadata.api.datasource.UserDatasource.class).name(serviceProperties.getControllerServiceName()))
                    .stream()
