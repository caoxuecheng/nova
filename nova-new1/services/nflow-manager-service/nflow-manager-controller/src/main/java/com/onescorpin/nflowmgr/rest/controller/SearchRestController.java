...
@Api(tags = "Nflow Manager - Search", produces = "application/json")
@Path("/v1/nflowmgr/search")
@Component
@SwaggerDefinition(tags = @Tag(name = "Nflow Manager - Search", description = "global search"))
public class SearchRestController {
    ...
    public Response search(@QueryParam("q") String query, @QueryParam("rows") @DefaultValue("20") Integer rows, @QueryParam("start") @DefaultValue("0") Integer start) {
        accessController.checkPermission(AccessController.SERVICES, NflowServicesAccessControl.ACCESS_GLOBAL_SEARCH);
