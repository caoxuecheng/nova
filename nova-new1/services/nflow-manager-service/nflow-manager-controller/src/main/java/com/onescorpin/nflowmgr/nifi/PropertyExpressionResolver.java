...
import com.onescorpin.nflowmgr.MetadataFields;
 ...
 * <li>Resolves {@code ${metadata.<NAME>}} to a {@link MetadataField} property of the {@link NflowMetadata} class.</li>
 * </ol>
 *
...
public class PropertyExpressionResolver {
    ...
    /**
     * Prefix for {@link NflowMetadata} property replacement
     */
    ...
    /**
     * Resolves the values for all properties of the specified nflow.
     *
     * @param metadata the nflow
     * @return the modified properties
     */
    @Nonnull
    public List<NifiProperty> resolvePropertyExpressions(@Nullable final NflowMetadata metadata) {
        if (metadata != null) {
    ...
    public List<NifiProperty> resolvePropertyExpressions(List<NifiProperty> properties, @Nullable final NflowMetadata metadata) {
    ...
    public List<AnnotatedFieldProperty> getMetadataProperties() {
        return MetadataFields.getInstance().getProperties(NflowMetadata.class);
    }
    ...
    /**
     * Resolves the value of the specified property of the specified nflow.
     *
     * @param metadata the nflow
     * @param property the property
     * @return {@code true} if the property was modified, or {@code false} otherwise
     */
    boolean resolveExpression(@Nonnull final NflowMetadata metadata, @Nonnull final NifiProperty property) {
    ...
    private String getMetadataPropertyValue(NflowMetadata metadata, String variableName) throws Exception {
     ...
     * @return the result of the transformation
     */
    private ResolveResult resolveVariables(@Nonnull final NifiProperty property, @Nonnull final NflowMetadata metadata) {
        // Filter blank values
