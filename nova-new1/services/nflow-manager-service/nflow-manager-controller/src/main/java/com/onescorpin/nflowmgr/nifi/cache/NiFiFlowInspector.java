    ...
    public NiFiFlowInspection inspect() {
        ...
        try {
            ...
            if (retryNumber < RETRIES) {
                ...
                log.error("Unable to inspect process group: {} after {} attempts.  Nova Operations Manager may have issues processing Jobs/Steps from NiFi. ", processGroupId, retryNumber);
            }
        }
        if (flow != null) {
