...
public class TableSetup {
    ...
    @JsonSerialize(as = DefaultTableSchema.class)
    @JsonDeserialize(as = DefaultTableSchema.class)
    private TableSchema nflowTableSchema;
    ...
    @MetadataField(description = "Hive Row Format String for the Nflow Table (example: ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\\n' STORED AS\n  TEXTFILE ")
    private String nflowFormat;
    ...
    @MetadataField(description = "List of destination (nflow table) field names separated by a new line")
    ...
    @MetadataField(description = "Structure of the nflow table")
    private String nflowFieldStructure;
    ...
    public String getFieldStructure(String type, TableSchema schema) {
        ...
        if (schema != null && schema.getFields() != null) {
            for (Field field : schema.getFields()) {
                ...
                String otherName = "";
                if(type.equalsIgnoreCase("NFLOW")) {
    ...
    @JsonIgnore
    public void updateNflowStructure() {
        setNflowFieldStructure(getFieldStructure("NFLOW",nflowTableSchema));
    }
    ...
    public void updateFieldPolicyNames() {
        if (tableSchema != null && tableSchema.getFields() != null && fieldPolicies != null && fieldPolicies.size() == tableSchema.getFields().size()) {
            ...
            for (FieldPolicy field : fieldPolicies) {
                ...
                sourceTargetFieldMap.put(field.getNflowFieldName(),field.getFieldName());
                targetSourceFieldMap.put(field.getFieldName(),field.getNflowFieldName());
                idx++;
            }
        }
    }
    ...
    public TableSchema getNflowTableSchema() {
        return nflowTableSchema;
    }

    public void setNflowTableSchema(TableSchema nflowTableSchema) {
        this.nflowTableSchema = nflowTableSchema;
    }
    ...
    public String getNflowFormat() {
        return nflowFormat;
    }

    public void setNflowFormat(String nflowFormat) {
        this.nflowFormat = nflowFormat;
    }
    ...
    public String getNflowFieldStructure() {
        return nflowFieldStructure;
    }

    public void setNflowFieldStructure(String nflowFieldStructure) {
        this.nflowFieldStructure = nflowFieldStructure;
    }
