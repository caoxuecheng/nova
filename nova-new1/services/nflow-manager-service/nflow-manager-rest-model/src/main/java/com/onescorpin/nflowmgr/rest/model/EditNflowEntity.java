...
import com.onescorpin.nflowmgr.rest.model.schema.EditNflowAction;
...
public class EditNflowEntity {


    private EditNflowAction action;
    private NflowMetadata nflowMetadata;

    public EditNflowAction getAction() {
        return action;
    }

    public void setAction(EditNflowAction action) {
        this.action = action;
    }
