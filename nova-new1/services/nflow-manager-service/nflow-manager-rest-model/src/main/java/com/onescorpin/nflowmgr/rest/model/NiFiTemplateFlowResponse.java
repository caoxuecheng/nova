...
public class NiFiTemplateFlowResponse {
    ...
    private List<NovaProcessorFlowTypeOption> processorFlowTypes;
    ...
    public NiFiTemplateFlowResponse() {
        processorFlowTypes =
            Lists.newArrayList(NovaProcessorFlowType.values()).stream().filter(flowType -> (!flowType.equals(NovaProcessorFlowType.NORMAL_FLOW) && !flowType.isDeprecated()))
                .map(flowType -> new NovaProcessorFlowTypeOption(flowType)).collect(Collectors.toList());
    }
    ...
    public List<NovaProcessorFlowTypeOption> getProcessorFlowTypes() {
        return processorFlowTypes;
    }

    public void setProcessorFlowTypes(List<NovaProcessorFlowTypeOption> processorFlowTypes) {
    ...
    public static class NovaProcessorFlowTypeOption {

        private String flowType;
        private String displayName;
        private String description;

        public NovaProcessorFlowTypeOption(NovaProcessorFlowType flowType) {
