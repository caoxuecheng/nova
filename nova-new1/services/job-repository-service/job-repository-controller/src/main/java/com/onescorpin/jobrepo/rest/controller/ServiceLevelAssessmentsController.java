...
import com.onescorpin.metadata.rest.model.sla.ServiceLevelAssessmentTransform;
    ...
    public ServiceLevelAssessment getAssessment(@PathParam("assessmentId")String assessmentId){
        ...
        if(assessmentId != null) {
            assessment = metadataAccess.read(() -> {
                com.onescorpin.metadata.sla.api.ServiceLevelAssessment.ID id = serviceLevelAssessmentProvider.resolveId(assessmentId);
                com.onescorpin.metadata.sla.api.ServiceLevelAssessment serviceLevelAssessment = serviceLevelAssessmentProvider.findServiceLevelAssessment(id);
