...
public class FieldPolicy implements Serializable {
    ...
    public String getNflowField() {
        return nflowField;
    }

    protected void setNflowField(String nflowField) {
        this.nflowField = nflowField;
    }
    ...
    public ValidationPolicy getNotNullValidator() {
        if ((validators !=null) && (validators.size() > 0)) {
            for (ValidationPolicy validationPolicy: validators) {
                if (validationPolicy.getClass().getName().equals("com.onescorpin.policy.validation.NotNullValidator")) {
