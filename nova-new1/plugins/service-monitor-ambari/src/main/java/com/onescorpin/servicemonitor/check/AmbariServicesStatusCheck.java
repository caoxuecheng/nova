...
import com.onescorpin.servicemonitor.rest.client.ambari.AmbariClient;
import com.onescorpin.servicemonitor.rest.model.ambari.Alert;
import com.onescorpin.servicemonitor.rest.model.ambari.AlertItem;
import com.onescorpin.servicemonitor.rest.model.ambari.AlertSummary;
import com.onescorpin.servicemonitor.rest.model.ambari.ServiceComponentInfoItem;
import com.onescorpin.servicemonitor.rest.model.ambari.ServiceComponentInfoSummary;
import com.onescorpin.servicemonitor.support.ServiceMonitorCheckUtil;
 ...
 *
 * Users can define what services/components to track in the nova properties file using the following format
 *
...
public class AmbariServicesStatusCheck implements ServicesStatusCheck {
    ...
    /**
     * Transform the ambari alerts to Nova service alerts
     */
