...
@ContextConfiguration(classes = {NovaClouderaClientTest.NovaClouderaHttpsClientTestConfig.class})
public class NovaClouderaClientTest {
    ...
    @Configuration
    @ComponentScan(basePackages = {"com.onescorpin.servicemonitor.rest.client.cdh"})
    public static class NovaClouderaHttpsClientTestConfig {
