...
import com.onescorpin.search.transform.ElasticSearchSearchResultTransform;
...
public class ElasticSearchService implements Search {
    ...
    private SearchResponse executeSearch(String query, int size, int start) {
        ...
        final String NOVA_CATEGORIES_DEFAULT = "nova-categories-default";
        final String NOVA_NFLOWS_METADATA = "nova-nflows-metadata";
        final String NOVA_NFLOWS_DEFAULT = "nova-nflows-default";
        ...
        SearchRequestBuilder searchRequestBuilder = client.prepareSearch()
            ...
            .setIndices(NOVA_CATEGORIES_METADATA,
                        NOVA_CATEGORIES_DEFAULT,
                        NOVA_NFLOWS_METADATA,
                        NOVA_NFLOWS_DEFAULT,
                        NOVA_DATA,
