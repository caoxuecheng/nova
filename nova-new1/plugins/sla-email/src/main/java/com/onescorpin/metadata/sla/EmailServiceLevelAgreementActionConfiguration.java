...
import com.onescorpin.metadata.sla.alerts.BaseServiceLevelAgreementActionConfiguration;
...
@ClassNameChange(classNames = {"com.onescorpin.metadata.sla.alerts.EmailServiceLevelAgreementActionConfiguration"})
