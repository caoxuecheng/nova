...
import com.onescorpin.metadata.sla.config.DeveloperEmailConfiguration;
...
public class TestEmail {
    ...
    public void testSlaEmail() {
        String email = "scott.reisdorf@onescorpin.com";
    ...
    private String getTemplate(){
       ...
       return
        ...
        + "        <tr>\n"
        + "\n"
        + "               <td align=\"center\" style=\"background-color:rgb(119, 119, 119);\"><img src=\"cid:nova-logo\"></td>\n"
        + "\n"
        + "        </tr>\n"
        + "\n"
        + "        <tr>\n"
    ...
    public void testVelocityEmail() {
        String email = "onescorpin.tester@gmail.com";
        String template = getTemplate();
