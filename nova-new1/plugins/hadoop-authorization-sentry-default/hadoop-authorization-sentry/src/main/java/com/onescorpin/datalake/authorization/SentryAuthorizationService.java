...
import com.onescorpin.datalake.authorization.client.SentryClientException;
import com.onescorpin.datalake.authorization.config.AuthorizationConfiguration;
import com.onescorpin.datalake.authorization.config.SentryConnection;
...
import com.onescorpin.kerberos.KerberosTicketGenerator;
...
public class SentryAuthorizationService extends BaseHadoopAuthorizationService {
    ...
    @Override
    public void createOrUpdateReadOnlyHivePolicy(String categoryName, String nflowName, List<String> hadoopAuthorizationGroups, String datebaseName, List<String> tableNames) {
                ...
                if(ugi==null){
                    ...
                    ugi.doAs(new PrivilegedExceptionAction<Void>() {
                        ...
                        public Void run() throws Exception {
                            String sentryPolicyName = getHivePolicyName(categoryName, nflowName);
                            if (!(sentryClientObject.checkIfRoleExists(sentryPolicyName))) {
                                createReadOnlyHivePolicy(categoryName, nflowName, hadoopAuthorizationGroups, datebaseName, tableNames);
                            } else {
                                try {
                                    updateReadOnlyHivePolicy(categoryName, nflowName, hadoopAuthorizationGroups, datebaseName, tableNames);
                                } catch (Exception e) {
    ...
    @Override
    public void createOrUpdateReadOnlyHdfsPolicy(String categoryName, String nflowName, List<String> hadoopAuthorizationGroups, List<String> hdfsPaths) {
            ...
            try {
                ...
                if(ugi==null){
                    ...
                    ugi.doAs(new PrivilegedExceptionAction<Void>() {
                        @Override
                        public Void run() throws Exception {
                            createReadOnlyHdfsPolicy(categoryName, nflowName, hadoopAuthorizationGroups, hdfsPaths);
                            return null;
                        }
                    });}
            } catch (Exception e) {
    ...
    @Override
    public void createReadOnlyHivePolicy(String categoryName, String nflowName, List<String> hadoopAuthorizationGroups, String datebaseName, List<String> tableNames) {
    ...
    @Override
    public void createReadOnlyHdfsPolicy(String categoryName, String nflowName, List<String> hadoopAuthorizationGroups, List<String> hdfsPaths) {
        ...
        try {
            ...
            log.error("Failed to apply ACL in HDFS Nova directories " + e.getMessage());
            throw new RuntimeException(e);
        }
    }

    @Override
    public void updateReadOnlyHivePolicy(String categoryName, String nflowName, List<String> groups, String datebaseName, List<String> tableNames) {
                        ...
                        public Void run() throws Exception {
                            ...
                            if (securityGroupNames == null || securityGroupNames.isEmpty()) {
                                ...
                                if (!StringUtils.isEmpty((String) nflowProperties.get(REGISTRATION_HDFS_FOLDERS))) {
                                    ...
                                    deleteHdfsPolicy(categoryName, nflowName, hdfsFolders);
                                }
                                ...
                                String sentryHivePolicyName = getHivePolicyName(categoryName, nflowName);
