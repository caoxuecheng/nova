 ...
 *
 */
package com.onescorpin.metadata.event.reactor;
...
import com.onescorpin.metadata.api.event.EventMatcher;
import com.onescorpin.metadata.api.event.MetadataEvent;
...
public class ReactorMetadataEventService implements MetadataEventService {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.event.MetadataEventService#notify(com.onescorpin.metadata.api.event.MetadataEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.event.MetadataEventService#addListener(com.onescorpin.metadata.api.event.MetadataEventListener)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.event.MetadataEventService#addListener(com.onescorpin.metadata.api.event.MetadataEventListener, com.onescorpin.metadata.api.event.EventMatcher)
     */
    @Override
