 ...
 *
 */
package com.onescorpin.metadata.persistence;

/*-
 * #%L
 * onescorpin-metadata-persistence
 * %%
...
import com.onescorpin.metadata.config.OperationalMetadataTransactionTemplateMetadataAccess;
...
public class AggregateMetadataAccess implements MetadataAccess {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#commit(com.onescorpin.metadata.api.MetadataCommand, com.onescorpin.metadata.api.MetadataRollbackCommand, java.security.Principal[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#commit(com.onescorpin.metadata.api.MetadataAction, java.security.Principal[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#commit(com.onescorpin.metadata.api.MetadataAction, com.onescorpin.metadata.api.MetadataRollbackAction, java.security.Principal[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#read(com.onescorpin.metadata.api.MetadataAction, java.security.Principal[])
     */
    @Override
