...
import com.onescorpin.metadata.api.user.GroupAlreadyExistsException;
import com.onescorpin.metadata.api.user.User;
import com.onescorpin.metadata.api.user.UserAlreadyExistsException;
import com.onescorpin.metadata.api.user.UserGroup;
import com.onescorpin.metadata.api.user.UserGroup.ID;
...
import com.onescorpin.metadata.modeshape.common.UsersPaths;
...
public class JcrUserProvider extends BaseJcrProvider<Object, Serializable> implements UserProvider {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#resolveUserId(java.io.Serializable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#resolveGroupId(java.io.Serializable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#userExists(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#findUserById(com.onescorpin.metadata.api.user.User.ID)
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#getUsers()
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#createUser(java.lang.String)
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#findGroupById(com.onescorpin.metadata.api.user.UserGroup.ID)
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#findGroupByName(java.lang.String)
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#getGroups()
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#ensureGroup(java.lang.String)
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserProvider#createGroup(java.lang.String)
     */
    @Nonnull
    @Override
