...
//    private Node actionsNode;
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.config.ActionsModuleBuilder#group(java.lang.String)
     */
    @Override
...
//            this.actionsNode = JcrUtil.getOrCreateNode(securityNode, name, JcrAllowedActions.NODE_TYPE);
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.config.ActionsModuleBuilder#build()
     */
    @Override
