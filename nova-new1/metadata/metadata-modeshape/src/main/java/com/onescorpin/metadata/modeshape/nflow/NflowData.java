 ...
 *
 */
public class NflowData extends JcrPropertiesEntity {

    public static final String NODE_TYPE = "tba:nflowData";
    ...
    public NflowData(Node node) {
        super(node);
    }

    public State getState() {
        return getProperty(STATE, Nflow.State.ENABLED);
    }
