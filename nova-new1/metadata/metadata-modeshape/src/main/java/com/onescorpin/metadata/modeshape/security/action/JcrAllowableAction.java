...
public class JcrAllowableAction extends JcrObject implements AllowableAction {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowableAction#getSystemName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowableAction#getTitle()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowableAction#getDescription()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.security.action.AllowableAction#getSubFunctions()
     */
    @Override
