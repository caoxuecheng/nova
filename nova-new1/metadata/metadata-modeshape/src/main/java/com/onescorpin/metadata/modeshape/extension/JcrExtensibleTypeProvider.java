...
import com.onescorpin.metadata.api.extension.ExtensibleType.ID;
import com.onescorpin.metadata.api.extension.ExtensibleTypeBuilder;
...
import com.onescorpin.metadata.api.extension.FieldDescriptor.Type;
import com.onescorpin.metadata.api.extension.FieldDescriptorBuilder;
...
import com.onescorpin.metadata.modeshape.TypeAlreadyExistsException;
...
public class JcrExtensibleTypeProvider implements ExtensibleTypeProvider {
    ...
    public boolean deleteType(final ID id) {
        ...
        try {
            ...
            return true;
        } catch (ItemNotFoundException | NoSuchNodeTypeException | NullPointerException e) {  // NOVA-8: Ignore NPE caused by unregistering a node type
            return true;
    ...
    /**
     * Return the Property names and types for a given NodeType (i.e. pass in tba:nflow).
     */
    @Override
