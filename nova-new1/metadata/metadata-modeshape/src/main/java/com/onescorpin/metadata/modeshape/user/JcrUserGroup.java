package com.onescorpin.metadata.modeshape.user;
...
public class JcrUserGroup extends AbstractJcrAuditableSystemEntity implements UserGroup {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.extension.ExtensibleEntity#getId()
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#isEnabled()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#setEnabled(boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#getUsers()
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#streamAllUsers()
     */
    @Nonnull
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#addUser(com.onescorpin.metadata.api.user.User)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#removeUser(com.onescorpin.metadata.api.user.User)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#getContainingGroups()
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#getAllContainingGroups()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#getGroups()
     */
    @Nonnull
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#streamAllGroups()
     */
    @Nonnull
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#addGroup(com.onescorpin.metadata.api.user.UserGroup)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#removeGroup(com.onescorpin.metadata.api.user.UserGroup)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#getPrincial()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.UserGroup#getRootPrincial()
     */
    @Override
    ...
    /**
     * A {@link com.onescorpin.metadata.api.user.UserGroup.ID} implementation identifying a UserGroup.
     */
