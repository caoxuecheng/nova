...
public class JcrUser extends AbstractJcrAuditableSystemEntity implements User {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.User#getAllContainingGroups()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.User#getContainingGroups()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.User#getPrincipal()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.user.User#getGroupPrincipals()
     */
    @Nonnull
    @Override
    ...
    /**
     * A {@link com.onescorpin.metadata.api.user.User.ID} representing a JCR User.
     */
