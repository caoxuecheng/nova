 ...
 * 
 */
package com.onescorpin.metadata.modeshape.versioning;
...
import com.onescorpin.metadata.core.BaseId;
...
//        this.id = new VersionId(JcrPropertyUtil.getIdentifier(version));
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.versioning.EntityVersion#getId()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.versioning.EntityVersion#getName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.versioning.EntityVersion#getCreatedDate()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.versioning.EntityVersion#getEntity()
     */
    @Override
