...
import com.onescorpin.metadata.api.MetadataAccessException;
...
import com.onescorpin.metadata.modeshape.security.ModeShapePrincipal;
import com.onescorpin.metadata.modeshape.security.ModeShapeReadOnlyPrincipal;
import com.onescorpin.metadata.modeshape.security.ModeShapeReadWritePrincipal;
import com.onescorpin.metadata.modeshape.security.OverrideCredentials;
import com.onescorpin.metadata.modeshape.security.SpringAuthenticationCredentials;
...
public class JcrMetadataAccess implements MetadataAccess {
     ...
     *
     * @see com.onescorpin.metadata.modeshape.support.JcrPropertyUtil#setProperty(Node, String, Object) which checks out the node before applying the update
     */
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#commit(com.onescorpin.metadata.api.MetadataCommand, java.security.Principal[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#commit(java.lang.Runnable, java.security.Principal[])
     */
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#read(com.onescorpin.metadata.api.MetadataCommand, java.security.Principal[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.api.MetadataAccess#read(java.lang.Runnable, java.security.Principal[])
     */
