 ...
 *
 */
package com.onescorpin.metadata.api.template.security;
...
public interface TemplateAccessControl {
    ...
    Action CREATE_NFLOW = ACCESS_TEMPLATE.subAction("createNflowFromTemplate",
                                                   "Create Nflow",
                                                   "Allows creating nflows under this template");
