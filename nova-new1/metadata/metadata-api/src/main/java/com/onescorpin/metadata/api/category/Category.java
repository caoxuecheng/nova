...
/**
 * A category is a collection of zero or more nflows.
 */
public interface Category extends AccessControlled {
    ...
    Set<RoleMembership> getNflowRoleMemberships();

    Optional<RoleMembership> getNflowRoleMembership(String roleName);
