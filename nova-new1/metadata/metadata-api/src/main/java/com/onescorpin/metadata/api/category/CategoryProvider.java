package com.onescorpin.metadata.api.category;
...
public interface CategoryProvider extends BaseProvider<Category, Category.ID> {
    ...
    /**
     * Gets the user fields for all nflows within the specified category.
     *
     ...
     */
    @Nonnull
    Optional<Set<UserFieldDescriptor>> getNflowUserFields(@Nonnull Category.ID categoryId);

    /**
     * Sets the user fields for all nflows within the specified category.
     *
     * @param categoryId the category id
     * @param userFields user field descriptors
     * @since 0.4.0
     */
    void setNflowUserFields(@Nonnull Category.ID categoryId, @Nonnull Set<UserFieldDescriptor> userFields);
