package com.onescorpin.metadata.api.user;
 ...
 *
 * <p>Users must have an entry in the metastore in order to access Nova. This class may be used for authentication if it has been enabled in the services configuration file.</p>
 */
public interface User {
    ...
    /**
     * Indicates that the user may access Nova.
     *
    ...
    /**
     * Enables or disables access to Nova for this user.
     */
