 ...
 *
 */
package com.onescorpin.metadata.api.category.security;
...
public interface CategoryAccessControl {
    ...
    Action CREATE_NFLOW = ACCESS_CATEGORY.subAction("createNflowUnderCategory",
                                                   "Create Nflow under Category",
                                                   "Allows creating nflows under this category");
