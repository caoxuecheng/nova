...
import com.onescorpin.spark.util.ArrayUtils;
...
public abstract class ScriptEngine {
    ...
    public synchronized Object eval(@Nonnull final String script, @Nonnull final List<NamedParam> bindings)
        ...
        cls.append("class Script (engine: com.onescorpin.spark.repl.ScriptEngine)");
        cls.append("    extends com.onescorpin.spark.repl.Script (engine) {\n");
