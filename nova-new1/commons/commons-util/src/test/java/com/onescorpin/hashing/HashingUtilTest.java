package com.onescorpin.hashing;
...
public class HashingUtilTest {
    ...
    public void testHashValue_NormalString() {
        String hash = HashingUtil.getHashMD5("{\"fname\":\"Mango\",\"fcolor\":\"Yellow\",\"ftaste\":\"Sweet\",\"nova_schema\":\"fruit_items\",\"nova_table\":\"fruits_nflow_01\"}");
