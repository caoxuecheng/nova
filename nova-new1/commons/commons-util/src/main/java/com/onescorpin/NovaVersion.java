...
/**
 * Represents the current Nova Version deployed in the system
 */
public interface NovaVersion extends Comparable<NovaVersion> {

    /**
     * Return the full Nova Version string as {@link #getMajorVersion()}.{@link #getMinorVersion()}
     *
     * @return the full nova version string
     */
    String getVersion();
    ...
    /**
     * Return the major versoin of Nova
     *
    ...
    /**
     * Return the minor version of Nova
     *
     * @return the minor version of Nova
     */
    ...
    /**
     * @return the point version of Nova
     */
     ...
     */
    NovaVersion withoutTag();

    /**
     * Return a description of the Nova version deployed
     *
     * @return a description of the Nova version deployed
     */
    ...
    /**
     * Update the current Nova version to the passed in version
     *
     * @param v the version to update to
     * @return the updated version
     */
    NovaVersion update(NovaVersion v);
}
