...
import com.onescorpin.nifi.rest.model.NiFiAllowableValue;
...
public class NifiPropertyUtil {
    ...
    private static void updateProperty(NifiProperty propertyToUpdate, NifiProperty nifiProperty, PROPERTY_MATCH_AND_UPDATE_MODE updateMode) {
        ...
        if(!PROPERTY_MATCH_AND_UPDATE_MODE.NFLOW_DETAILS_MATCH_TEMPLATE.equals(updateMode)){
            //if its Not updating for editing a Nflow then attempt to set the render type properties.
            //otherwise the 'propertyToUpdate' will be the registeredTemplate  property and should not be updated from the nflow values as the template should drive how the nflow is rendered.
    ...
    public static void updateMatchingProperty(NifiProperty matchingProperty, NifiProperty nifiProperty, PROPERTY_MATCH_AND_UPDATE_MODE updateMode) {
        if (updateMode.performUpdate()) {
            if (matchingProperty.getValue() == null || (matchingProperty.getValue() != null && (PROPERTY_MATCH_AND_UPDATE_MODE.UPDATE_ALL_PROPERTIES.equals(updateMode) || PROPERTY_MATCH_AND_UPDATE_MODE.NFLOW_DETAILS_MATCH_TEMPLATE.equals(updateMode) || (
    ...
    public static enum PROPERTY_MATCH_AND_UPDATE_MODE {
        ...
        /**
         * update the template properties with the Nflow properties
         */
        NFLOW_DETAILS_MATCH_TEMPLATE;
