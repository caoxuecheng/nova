package com.onescorpin.nifi.rest.model;
...
public class NifiProperty {
    ...
    /**
     * flag indicating the admin chose to allow the user to configure this property when creating a nflow
     **/
    ...
    /**
     * flag indicating the property is selected for modification in the nova ui
     **/
    ...
    /**
     * flag to indicate the property is sensitive.  Nova will encrypt the sensitive properties before saving in the metadata.
     */
    ...
    /**
     * a copy of the Template Property so it can be referenced back to when displaying data between the Nflow and the template used
     **/
