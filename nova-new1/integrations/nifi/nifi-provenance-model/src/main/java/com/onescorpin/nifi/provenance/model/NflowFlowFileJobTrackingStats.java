...
import com.onescorpin.nifi.provenance.model.util.LongIdGenerator;
 ...
 */
public class NflowFlowFileJobTrackingStats implements Serializable{
    ...
    private String nflowFlowFileId;

    private String firstEventProcessorId;

    private String primaryRelatedBatchNflowFlow;

    public NflowFlowFileJobTrackingStats(){

    }

    public NflowFlowFileJobTrackingStats(String firstEventProcessorId,String nflowFlowFileId){
        this.nflowFlowFileId = nflowFlowFileId;
    ...
    public List<ProvenanceEventRecordDTO> getUpdatedProvenanceEvents(){
        ...
        if(updatedProcessors != null){
            ...
            for(String processorId: updatedProcessors) {
                ...
                event.setJobFlowFileId(nflowFlowFileId);
                String ffId = nflowFlowFileId;
               // event.setStreamingBatchNflowFlowFileId(ffId);
                event.setFlowFileUuid(ffId);
                event.setJobFlowFileId(ffId);

                event.setEventId(LongIdGenerator.nextId());
                event.setEventType("NOVA");
