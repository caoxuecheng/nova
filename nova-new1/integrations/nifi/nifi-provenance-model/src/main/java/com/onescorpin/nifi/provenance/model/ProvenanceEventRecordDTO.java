...
import com.onescorpin.nifi.provenance.model.util.ProvenanceEventDtoUtil;
...
/**
 * This is used in both the NiFi NovaReportingTask and also in Nova Operations Manager
 *
 *
 * Note: Any modifications to this class will result in the need to update nova-services and the NovaReportingTask nar
 */
...
public class ProvenanceEventRecordDTO implements Serializable {
    ...
    /**
     * The Nflow name  {category}.{nflow}
     */
    private String nflowName;
    /**
     * The processgroup that is holding the flow for this nflow
     */
    private String nflowProcessGroupId;

    private NovaProcessorFlowType processorType;
    ...
    public NovaProcessorFlowType getProcessorType() {
        return processorType;
    }

    public void setProcessorType(NovaProcessorFlowType processorType) {
    ...
    public String toString() {
        ...
        sb.append(", nflow=").append(getNflowName());
