...
@Tags({"hive", "ddl", "merge", "sync", "onescorpin"})
@CapabilityDescription("Fully synchronize or Merge values from a nflow partition into the target table optionally supporting de-dupe and overwriting partitions. Sync will overwrite the entire table "
                       + "to match the source."
)
