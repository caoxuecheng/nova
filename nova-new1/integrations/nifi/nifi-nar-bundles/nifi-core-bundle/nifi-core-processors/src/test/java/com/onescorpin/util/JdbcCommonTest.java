...
import com.onescorpin.nifi.thrift.api.RowVisitor;
...
public class JdbcCommonTest {
    ...
    /**
     * Verify schema format for setting up nflow table
     */
    @Test
    public void getAvroSchemaForNflowSetupTest() {
        final Schema schema = SchemaBuilder
            .record("test_record")
            .namespace("my_schema")
            .fields()
        ...
        String obtained = JdbcCommon.getAvroSchemaForNflowSetup(schema);
        ...
        assertEquals("Avro schema not mapped correctly for nflow table setup", expected, obtained);
    }
}
