...
public class TableRegisterConfiguration {
    ...
    public TableRegisterConfiguration(String nflowRoot, String profileRoot, String masterRoot) {
        super();
        this.nflowRoot = StringUtils.defaultIfEmpty(nflowRoot, DEFAULT_NFLOW);
