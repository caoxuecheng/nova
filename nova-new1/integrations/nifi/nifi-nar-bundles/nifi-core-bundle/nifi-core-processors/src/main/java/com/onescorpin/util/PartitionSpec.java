...
public class PartitionSpec implements Cloneable {
    ...
    public static void main(String[] args) {
        ...
        /*
             ...
             select id, name, company, zip, phone, email, hired from employee_nflow
        ...
        String sourceTable = "employee_nflow";
        String sqlWhere = "employee_nflow";
     ...
     */
    public String toDistinctSelectSQL(@Nonnull final String sourceSchema, @Nonnull final String sourceTable, @Nonnull final String nflowPartitionValue) {
