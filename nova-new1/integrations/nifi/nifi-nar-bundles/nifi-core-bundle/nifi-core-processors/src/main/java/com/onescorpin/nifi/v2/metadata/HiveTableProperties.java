...
public interface HiveTableProperties {
    ...
    PropertyDescriptor DATABASE_NAME = new PropertyDescriptor.Builder()
        ...
        .description("The name of the database containing the table where the nflow writes its processing results")
        .required(true)
    ...
    PropertyDescriptor TABLE_NAME = new PropertyDescriptor.Builder()
        ...
        .description("The name of the table where the nflow writes its processing results")
        .required(true)
        .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
        .build();
    ...
    PropertyDescriptor TABLE_LOCATION = new PropertyDescriptor.Builder()
        ...
        .description("The URI specifying the location where the nflow writes its processing results")
        .required(false)
