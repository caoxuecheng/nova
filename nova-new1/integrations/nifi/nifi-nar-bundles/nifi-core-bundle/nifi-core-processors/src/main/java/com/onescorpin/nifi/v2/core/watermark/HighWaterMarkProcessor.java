 ...
 */
public abstract class HighWaterMarkProcessor extends NflowProcessor {

    protected static final PropertyDescriptor HIGH_WATER_MARK = new PropertyDescriptor.Builder()
        .name("High-Water Mark")
        .description("The name to be given to this high-water mark, stored in the nflow's metadata, which records the latest committed water mark value")
