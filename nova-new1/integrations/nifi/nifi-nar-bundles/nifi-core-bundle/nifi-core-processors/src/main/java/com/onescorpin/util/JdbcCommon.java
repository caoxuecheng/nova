...
public class JdbcCommon {
    ...
    /**
     * Get schema in the format for setting up the nflow table
     * @param schema Avro Schema
     * @return formatted schema for setting up nflow table
     */
    public static String getAvroSchemaForNflowSetup (Schema schema) {
        if (schema == null) {
            return "";
        }
