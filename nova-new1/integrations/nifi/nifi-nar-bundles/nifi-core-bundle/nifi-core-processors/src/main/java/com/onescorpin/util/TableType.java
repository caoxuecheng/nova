...
public enum TableType {
    ...
    NFLOW("nflow", true, false, true, false, true),
    ...
    private boolean nflowPartition;
    private boolean addReasonCode;
    private boolean external;
    private boolean appendProcessingDttmField;

    TableType(String suffix, boolean nflowPartition, boolean useTargetStorageSpec, boolean strings, boolean addReasonCode, boolean external, boolean appendProcessingDttmField) {
        this.tableSuffix = suffix;
        this.nflowPartition = nflowPartition;
    ...
    TableType(String suffix, boolean nflowPartition, boolean useTargetStorageSpec, boolean strings, boolean addReasonCode, boolean external) {
        this(suffix, nflowPartition, useTargetStorageSpec, strings, addReasonCode, external, false);
    }
    ...
    public boolean isStrings(String nflowFormatOptions) {
        ...
        if (allStrings && nflowFormatOptions != null) {
            String urawFormatOptions = nflowFormatOptions.toUpperCase();
    ...
    public String deriveColumnSpecification(ColumnSpec[] columns, ColumnSpec[] partitionColumns, String nflowFormatOptions) {
        boolean allStrings = isStrings(nflowFormatOptions);
        Set<String> partitionSet = new HashSet<>();
        if (!nflowPartition && partitionColumns != null && partitionColumns.length > 0) {
    ...
    public boolean isNflowPartition() {
        return nflowPartition;
    }
