package com.onescorpin.nifi.provenance.config;
...
import com.onescorpin.nifi.provenance.repo.ConfigurationPropertiesRefresher;
...
/**
 * Spring bean configuration for Nova NiFi Provenance
 */
@Configuration
