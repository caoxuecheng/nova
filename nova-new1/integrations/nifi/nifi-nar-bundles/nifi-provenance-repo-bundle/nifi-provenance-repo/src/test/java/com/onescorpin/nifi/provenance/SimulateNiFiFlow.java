...
public class SimulateNiFiFlow {
    ...
    public SimulateNiFiFlow(NflowStatisticsManager nflowStatisticsManager) {
        this.nflowStatisticsManager = nflowStatisticsManager;
    }
    ...
    private String componentType = "com.onescorpin.ComponentType";
    public void create() {
...
private ProvenanceEventRecord applySleepTime(ProvenanceEventRecord eventRecord, Long sleepTime, boolean applyToFlowFileEntryDate){
    ...
    private boolean addToFlow(ProvenanceEventRecord event, Long sleepTime,boolean applyToFlowFileEntryDate){
        ...
        nflowStatisticsManager.addEvent(event,id);
    ...
    public Long getSkippedCount() {
        return NflowEventStatistics.getInstance().getSkippedEvents();
    }
}
