 ...
 */
public class JmsNflowPreconditionEventService extends AbstractControllerService implements NflowPreconditionEventService {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.controller.precond.NflowPreconditionEventService#addListener(java.lang.String, com.onescorpin.controller.precond.PreconditionListener)
     */
    @Override
    public void addListener(String category, String nflowName, PreconditionListener listener) {
        ...
        getLogger().debug("Adding preconditon listener: {}.{} - {} to consumer {}", new Object[]{category, nflowName, listener, consumer});

        consumer.addListener(category, nflowName, listener);
    }

    /* (non-Javadoc)
     * @see com.onescorpin.controller.precond.NflowPreconditionEventService#removeListener(com.onescorpin.controller.precond.PreconditionListener)
     */
    @Override
