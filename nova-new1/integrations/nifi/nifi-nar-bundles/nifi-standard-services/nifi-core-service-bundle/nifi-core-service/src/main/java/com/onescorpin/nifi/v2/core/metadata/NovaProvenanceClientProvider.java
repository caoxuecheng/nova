...
/**
 * an implementation of NovaNifiFlowProvider, used to interact with a cache of nifi flow events
 */
public class NovaProvenanceClientProvider implements NovaNiFiFlowProvider {
     ...
     */
    public NovaProvenanceClientProvider(MetadataClient client) {
        super();
        this.client = client;
    }
