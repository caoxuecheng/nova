...
public class MetadataProviderSelectorService extends AbstractControllerService implements MetadataProviderService {
    ...
    private volatile NovaProvenanceClientProvider novaProvenanceClientProvider;
    ...
    public void onConfigured(final ConfigurationContext context) throws InitializationException {
        ...
        if (impl.getValue().equalsIgnoreCase("REMOTE")) {
            ...
            this.novaProvenanceClientProvider = new NovaProvenanceClientProvider(client);
        } else {
    ...
    public NovaNiFiFlowProvider getNovaNiFiFlowProvider() {
        return this.novaProvenanceClientProvider;
    }
