...
public class JmsCleanupEventServiceTest {
    ...
    public void testValidators() {
        ...
        String expected = "'Nflow Cleanup Event Service' validated against 'cleanupEventService' is invalid because Controller Service is not valid: 'Spring Context Service' is invalid because Spring "
    ...
    public void test() throws Exception {
        ...
        cleanupService.addListener("cat", "nflow", listener);
        Mockito.verify(consumer).addListener("cat", "nflow", listener);
