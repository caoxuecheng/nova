...
import com.onescorpin.spark.policy.FieldPolicyLoader;
...
public class Profiler {
    ...
    private com.onescorpin.spark.dataprofiler.Profiler profiler;
    ...
    public static void main(String[] args) {
        final ApplicationContext ctx = new AnnotationConfigApplicationContext("com.onescorpin.spark");
        final Profiler profiler = new Profiler(ctx.getBean(FieldPolicyLoader.class), ctx.getBean(com.onescorpin.spark.dataprofiler.Profiler.class), ctx.getBean(ProfilerConfiguration.class),
                                               ctx.getBean(SparkContextService.class), ctx.getBean(SQLContext.class));
        profiler.run(args);
    }

    public Profiler(FieldPolicyLoader loader, com.onescorpin.spark.dataprofiler.Profiler profiler, ProfilerConfiguration profilerConfiguration,
