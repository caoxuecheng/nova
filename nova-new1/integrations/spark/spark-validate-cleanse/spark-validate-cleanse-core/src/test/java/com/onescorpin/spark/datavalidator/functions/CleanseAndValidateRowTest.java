...
/*-
 * #%L
 * onescorpin-spark-validate-cleanse-app
 * %%
...
import com.onescorpin.policy.FieldPolicyBuilder;
import com.onescorpin.policy.standardization.LowercaseStandardizer;
import com.onescorpin.policy.standardization.SimpleRegexReplacer;
import com.onescorpin.policy.standardization.StandardizationPolicy;
import com.onescorpin.policy.standardization.UppercaseStandardizer;
import com.onescorpin.policy.validation.CharacterValidator;
import com.onescorpin.policy.validation.LookupValidator;
...
import com.onescorpin.spark.datavalidator.StandardDataValidator;
...
public class CleanseAndValidateRowTest {
    ...
    private ValidationResult rangeValidate(Number min, Number max, String dataType, String value) {
        ...
        FieldPolicy fieldPolicy = FieldPolicyBuilder.newBuilder().addPolicies(policies).tableName("emp").fieldName("field1").nflowFieldName("field1").addPolicies(policies).build();
    ...
    public void standardizeRegex() {
        ...
        FieldPolicy fieldPolicy = FieldPolicyBuilder.newBuilder().addPolicies(policies).tableName("emp").fieldName(fieldName).nflowFieldName(fieldName).build();
    ...
    private ValidationResult notNullValidate(String dataType, String value, boolean allowEmptyString, boolean trimString) {
        ...
        List<BaseFieldPolicy> policies = new ArrayList<>();
        policies.add(validatorPolicy);
        FieldPolicy fieldPolicy = FieldPolicyBuilder.newBuilder().addPolicies(policies).tableName("emp").fieldName("field1").nflowFieldName("field1").build();
    ...
    public void standardizeShouldNotChangeType() {
        ...
        policies.add(ADD_ONE_STANDARDISATION_POLICY);
        FieldPolicy fieldPolicy = FieldPolicyBuilder.newBuilder().addPolicies(policies).tableName("temp").fieldName(fieldName).nflowFieldName(fieldName).build();
