...
/*-
 * #%L
 * nova-spark-validate-cleanse-app
 * %%
...
public class Validator {
    ...
    private int run(@Nonnull final PrintStream out, @Nonnull final String... args) {
        ...
        // Run validation
        final DataValidatorResult results = app.validateTable(params.getTargetDatabase(), params.getNflowTableName(), params.getValidTableName(), params.getPartition(), params.getNumPartitions(),
        ...
        app.saveValidToTable(params.getTargetDatabase(), params.getNflowTableName(), params.getValidTableName(), results, hiveContext);
