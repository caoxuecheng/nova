package com.onescorpin.spark.dataquality.checker;

/*-
 * #%L
 * nova-spark-job-dataquality-app
 * %%
...
public class DataQualityChecker {
    ...
    public static void main(String[] args) {
        ...
        try {
            ApplicationContext ctx = new AnnotationConfigApplicationContext("com.onescorpin.spark");
    ...
    public void setArguments(String categoryName, String nflowName) {
    ...
    public void doDataQualityChecks() {
        try {
            ...
            String sql = "SELECT COUNT(*) FROM " + categoryName + "." + nflowName;
            ...
            log.info("Total rows in {}.{}: {}", categoryName, nflowName, rowCount);
        } catch (Exception e) {
