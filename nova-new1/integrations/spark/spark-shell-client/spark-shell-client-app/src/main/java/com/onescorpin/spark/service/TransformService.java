...
import com.onescorpin.spark.metadata.TransformJob;
...
public class TransformService {
    ...
    String toScript(@Nonnull final TransformRequest request) {
        ...
        script.append("class Transform (destination: String, policies: Array[com.onescorpin.policy.rest.model.FieldPolicy], validator: com.onescorpin.spark.datavalidator.DataValidator,"
                      + " profiler: com.onescorpin.spark.dataprofiler.Profiler, sqlContext: org.apache.spark.sql.SQLContext,"
                      + " sparkContextService: com.onescorpin.spark.SparkContextService) extends ");
