...
/**
 * Registers this Spark Shell client with a remote Nova services server.
 */
public class RemoteClientRunner implements ApplicationRunner {
    ...
    /**
     * Registers this Spark Shell client with the remote Nova services server.
     */
    public void register() {
        ...
        final String clientId = System.getenv("NOVA_CLIENT_ID");
        Preconditions.checkNotNull(clientId, "Environment variable is not defined: NOVA_CLIENT_ID");

        final String clientSecret = System.getenv("NOVA_CLIENT_SECRET");
        Preconditions.checkNotNull(clientSecret, "Environment variable is not defined: NOVA_CLIENT_SECRET");
    ...
    /**
     * Creates a REST client for communicating with the Nova services server.
     *
