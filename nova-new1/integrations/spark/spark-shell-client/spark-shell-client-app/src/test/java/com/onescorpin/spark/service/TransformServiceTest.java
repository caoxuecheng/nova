package com.onescorpin.spark.service;

/*-
 * #%L
 * onescorpin-spark-shell-client-app
 * %%
...
import com.onescorpin.spark.metadata.TransformScript;
import com.onescorpin.spark.repl.SparkScriptEngine;
...
import com.onescorpin.spark.shell.DatasourceProvider;
import com.onescorpin.spark.shell.DatasourceProviderFactory;
...
public class TransformServiceTest {
    ...
    public void execute() throws Exception {
        ...
        Assert.assertEquals("Array[com.onescorpin.policy.rest.model.FieldPolicy]", bindings.get(0).tpe());
        Assert.assertNull(bindings.get(0).value());

        Assert.assertEquals("profiler", bindings.get(1).name());
        Assert.assertEquals("com.onescorpin.spark.dataprofiler.Profiler", bindings.get(1).tpe());
        Assert.assertNull(bindings.get(1).value());

        Assert.assertEquals("sparkContextService", bindings.get(2).name());
        Assert.assertEquals("com.onescorpin.spark.SparkContextService", bindings.get(2).tpe());
        ...
        Assert.assertEquals("com.onescorpin.spark.datavalidator.DataValidator", bindings.get(4).tpe());
    ...
    public void executeWithDatasourceProviderFactory() throws Exception {
        ...
        Assert.assertEquals("com.onescorpin.spark.shell.DatasourceProvider[org.apache.spark.sql.DataFrame]", bindings.get(5).tpe());
