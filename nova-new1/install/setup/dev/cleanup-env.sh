...
read -p "Are you sure you want to uninstall all Nova components AND delete the nova database? Type YES to confirm: " CONFIRM_DELETE

if [ "$CONFIRM_DELETE" == "YES" ] ; then

echo "Uninstalling all components that were installed from the RPM and setup-wizard"
echo "Uninstalling nova applications with RPM uninstall"
/opt/nova/remove-nova.sh
rm -rf /opt/nova
mysql -phadoop -e "drop database nova;"
