...
DROP TABLE IF EXISTS NFLOW_DESTINATION;
DROP TABLE IF EXISTS NFLOW_SOURCE;
DROP TABLE IF EXISTS DATASOURCE;

DROP TABLE IF EXISTS NFLOW_PROPERTIES;
DROP TABLE IF EXISTS FM_TEMPLATE;
DROP TABLE IF EXISTS CATEGORY;
DROP TABLE IF EXISTS FM_NFLOW;

IF EXISTS(SELECT table_name
            FROM INFORMATION_SCHEMA.COLUMNS
           WHERE table_schema = 'nova'
             AND table_name LIKE 'NFLOW' and COLUMN_NAME = 'category_id')
