...
CREATE TABLE IF NOT EXISTS `NOVA_ALERT` (
...
CREATE TABLE IF NOT EXISTS `NOVA_ALERT_CHANGE` (
...
IF NOT EXISTS(SELECT table_name
           ...
           WHERE table_schema = 'nova'
             AND table_name = 'NIFI_NFLOW_PROCESSOR_STATS' and column_name = 'CLUSTER_NODE_ID') THEN

ALTER TABLE `NIFI_NFLOW_PROCESSOR_STATS`
