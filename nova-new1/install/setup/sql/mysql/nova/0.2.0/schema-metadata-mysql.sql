...
create table NFLOW_DESTINATION (id binary(16) not null, created_time datetime, modified_time datetime, datasource_id binary(16), nflow_id binary(16), primary key (id)) ENGINE=InnoDB;
create table NFLOW_PROPERTIES (JpaNflow_id binary(16) not null, prop_value varchar(255), prop_key varchar(100) not null, primary key (JpaNflow_id, prop_key)) ENGINE=InnoDB;
create table NFLOW_SOURCE (id binary(16) not null, created_time datetime, modified_time datetime, datasource_id binary(16), nflow_id binary(16), agreement_id binary(16), primary key (id)) ENGINE=InnoDB;
