package com.onescorpin.ui.api.template;
...
/**
 * Extends the options available when creating or editing a nflow.
 */
...
public interface TemplateTableOption {
    ...
    /**
     * Gets the template URL containing sections for viewing or editing a nflow.
     */
    @Nullable
    default String getNflowDetailsTemplateUrl() {
        return null;
    }
    ...
    /**
     * Gets the template URL containing steps for creating or editing a nflow.
     */
    @Nullable
    ...
    /**
     * Gets the template URL containing any pre steps for creating a nflow
     * Pre steps are rendered before the General Info step.
     * These are useful if you want to create a form to determine if a user should continue and create the nflow or not
     */
    @Nullable
    ...
    default String getPreNflowDetailsTemplateUrl() { return null;}
    ...
    /**
     * Gets the number of additional steps for creating or editing a nflow.
     ...
     * This will get called both for Creating and Editing a nflow to let you preset model defaults or enable/disable sections
     * @return
     */
