...
public class DefaultTemplateTableOption implements TemplateTableOption {
    ...
    private String preNflowDetailsTemplateUrl;
    ...
    @Override
    public String getPreNflowDetailsTemplateUrl() {
        return preNflowDetailsTemplateUrl;
    }

    public void setPreNflowDetailsTemplateUrl(String preNflowDetailsTemplateUrl) {
        this.preNflowDetailsTemplateUrl = preNflowDetailsTemplateUrl;
    }
