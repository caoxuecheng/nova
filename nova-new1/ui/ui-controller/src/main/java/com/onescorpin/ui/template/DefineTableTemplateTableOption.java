...
/**
 * Steps for defining the destination Hive table and data processing operations on a nflow.
 */
@Component
public class DefineTableTemplateTableOption implements TemplateTableOption {
    ...
    public String getNflowDetailsTemplateUrl() {
        return "js/plugin/template-table-option/define-table/define-table-nflow-details.html";
    }
