...
import com.onescorpin.auth.AuthServiceAuthenticationProvider;
import com.onescorpin.auth.AuthenticationService;
import com.onescorpin.auth.jaas.config.JaasAuthConfig;
import com.onescorpin.auth.jwt.JwtRememberMeServices;
...
public class DefaultWebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    @Inject
    private NovaTargetUrlLoginSuccessHandler novaTargetUrlLoginSuccessHandler;
...
//                .anyRequest().authenticated()
            ...
            .formLogin()
               ...
               .successHandler(novaTargetUrlLoginSuccessHandler)
                .and()
            .logout() 
                .permitAll()
                .and()
