...
define(['angular', 'nflow-mgr/visual-query/build-query/flowchart/flowchart_viewmodel','nflow-mgr/visual-query/build-query/flowchart/mouse_capture_service','nflow-mgr/visual-query/build-query/flowchart/svg_class','nflow-mgr/visual-query/build-query/flowchart/dragging_service'], function (angular) {
...
//
    angular.module('flowChart', ['dragging'])
        ...
        .directive('flowChart', function () {
            return {
                restrict: 'E',
                templateUrl: "js/nflow-mgr/visual-query/build-query/flowchart/flowchart_table_template.html",
                replace: true,
                scope: {
                    chart: "=chart",
