define(['angular',"nflow-mgr/module-name"], function (angular,moduleName) {
    ...
    var controller = function ($scope, $mdDialog, $mdToast, $http, StateService, NflowService, PolicyInputFormService, FieldPolicyRuleOptionsFactory, NflowFieldPolicyRuleService, nflow, field) {
        $scope.nflow = nflow;
        $scope.options = [];
        $scope.field = field;
        $scope.ruleMode = 'NEW'
        ...
        FieldPolicyRuleOptionsFactory.getStandardizersAndValidators().then(function (response) {
            ...
            if ($scope.nflow != null) {
                currentNflowValue = PolicyInputFormService.currentNflowValue($scope.nflow);
                currentNflowValue = currentNflowValue.toLowerCase();
            }
            ...
            standardizers = PolicyInputFormService.groupPolicyOptions(standardizationResults, currentNflowValue);
            validators = PolicyInputFormService.groupPolicyOptions(validationResults, currentNflowValue);
        ...
        function changedOptionType(type) {
         ...
         function setupPoliciesForNflow(){
             var arr = NflowFieldPolicyRuleService.getAllPolicyRules(field);
             if (arr != null && arr != undefined) {
                 $scope.policyRules = angular.copy(arr);
             }
         }
        setupPoliciesForNflow();
    ...
    angular.module(moduleName).controller('NflowFieldPolicyRuleDialogController', ["$scope","$mdDialog","$mdToast","$http","StateService","NflowService","PolicyInputFormService","FieldPolicyRuleOptionsFactory", "NflowFieldPolicyRuleService","nflow","field",controller]);
    ...
    angular.module(moduleName).factory('NflowFieldPolicyRuleService', [function () {
