...
define(["require", "exports", "@angular/core", "angular", "underscore", "../services/query-engine"], function (require, exports, core_1, angular, _, query_engine_1) {
    ...
    var QueryBuilderComponent = (function () {
         ...
         */
        function QueryBuilderComponent($scope, $element, $mdToast, $mdDialog, $document, Utils, RestUrlService, HiveService, SideNavService, StateService, VisualQueryService, NflowService, DatasourcesService) {
            this.$scope = $scope;
        ...
        QueryBuilderComponent.prototype.showConnectionDialog = function (isNew, connectionViewModel, connectionDataModel, source, dest) {
            ...
            this.$mdDialog.show({
                ...
                templateUrl: 'js/nflow-mgr/visual-query/build-query/connection-dialog/connection-dialog.component.html',
    ...
    angular.module(moduleName).component("onescorpinVisualQueryBuilder", {
        bindings: {
            engine: "=",
            heightOffset: "@",
            model: "=",
        ...
        controller: ["$scope", "$element", "$mdToast", "$mdDialog", "$document", "Utils", "RestUrlService", "HiveService", "SideNavService", "StateService", "VisualQueryService", "NflowService",
            "DatasourcesService", QueryBuilderComponent],
        controllerAs: "$bq",
        require: {
            stepperController: "^onescorpinStepper"
        },
        templateUrl: "js/nflow-mgr/visual-query/build-query/build-query.component.html"
    });
});
