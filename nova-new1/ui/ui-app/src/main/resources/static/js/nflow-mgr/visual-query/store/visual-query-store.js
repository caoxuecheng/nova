define(['angular',"nflow-mgr/visual-query/module-name"], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/nflow-mgr/visual-query/store/visual-query-store.html',
    ...
    angular.module(moduleName)
        .directive('onescorpinVisualQueryStore', directive);
