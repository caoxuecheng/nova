define(['angular',"nflow-mgr/module-name"], function (angular,moduleName) {
    /**
     * A user-defined property field (or business metadata) for categories or nflows.
     *
     ...
     */
    function onescorpinPropertiesAdmin() {
        return {
            ...
            templateUrl: "js/nflow-mgr/shared/properties-admin/properties-admin.html"
        };
    }
     ...
     * @returns {Object} the directive
     */
    function onescorpinPropertiesAdminEditor() {
        return _.defaults({
            templateUrl: "js/nflow-mgr/shared/properties-admin/properties-admin-editor.html"
        }, onescorpinPropertiesAdmin());
    }

    angular.module(moduleName).controller("PropertiesAdminController", ["$scope",PropertiesAdminController]);
    angular.module(moduleName).directive("onescorpinPropertiesAdmin", onescorpinPropertiesAdmin);
    angular.module(moduleName).directive("onescorpinPropertiesAdminEditor", onescorpinPropertiesAdminEditor);
});
