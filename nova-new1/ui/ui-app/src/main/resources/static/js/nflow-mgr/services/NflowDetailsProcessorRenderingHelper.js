...
define(['angular','nflow-mgr/module-name'], function (angular,moduleName) {
    angular.module(moduleName).factory('NflowDetailsProcessorRenderingHelper', function () {

        var data = {
            GET_TABLE_DATA_PROCESSOR_TYPE: "com.onescorpin.nifi.GetTableData",
            GET_TABLE_DATA_PROCESSOR_TYPE2: "com.onescorpin.nifi.v2.ingest.GetTableData",
            WATERMARK_PROCESSOR: 'com.onescorpin.nifi.v2.core.watermark.LoadHighWaterMark',
            SQOOP_PROCESSOR: 'com.onescorpin.nifi.v2.sqoop.core.ImportSqoop',
