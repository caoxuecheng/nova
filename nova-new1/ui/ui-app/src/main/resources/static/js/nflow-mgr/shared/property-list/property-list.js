define(['angular',"nflow-mgr/module-name"], function (angular,moduleName) {
    /**
     * A user-defined property (or business metadata) on a category or nflow.
     *
     ...
     */
    function onescorpinPropertyList() {
        return {
            ...
            templateUrl: "js/nflow-mgr/shared/property-list/property-list.html"
        };
    }
     ...
     * @returns {Object} the directive
     */
    function onescorpinPropertyListEditor() {
        return _.defaults({
            templateUrl: "js/nflow-mgr/shared/property-list/property-list-editor.html"
        }, onescorpinPropertyList());
    }

    angular.module(moduleName).controller("PropertyListController",["$scope", PropertyListController]);
    angular.module(moduleName).directive("onescorpinPropertyList", onescorpinPropertyList);
    angular.module(moduleName).directive("onescorpinPropertyListEditor", onescorpinPropertyListEditor);
});
