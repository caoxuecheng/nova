 ...
 */
const HEADER_TEMPLATE = "js/nflow-mgr/visual-query/transform-data/visual-query-table/visual-query-table-header.html";
...
export class VisualQueryPainterService extends fattable.Painter {
    ...
    constructor(private $compile: angular.ICompileService, private $mdPanel: angular.material.IPanelService, private $scope: angular.IRootScopeService,
        ...
        this.menuPanel = $mdPanel.create({
            ...
            templateUrl: "js/nflow-mgr/visual-query/transform-data/visual-query-table/cell-menu.template.html"
        });
...
angular.module(require("nflow-mgr/visual-query/module-name")).service("VisualQueryPainterService", VisualQueryPainterService);
