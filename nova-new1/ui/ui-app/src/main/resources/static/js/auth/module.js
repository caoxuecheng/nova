define(['angular','auth/module-name','nova-utils/LazyLoadUtil','constants/AccessConstants', 'nova-services'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
