define(['angular', 'nflow-mgr/categories/module-name'], function (angular, moduleName) {
    ...
    var directive = function () {
        return {
            ...
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/nflow-mgr/categories/details/category-access-control.html',
    ...
    function CategoryAccessControlController($scope, $q, $mdToast, CategoriesService, AccessControlService, EntityAccessControlService) {
        ...
        if (CategoriesService.model.nflowRoleMemberships == undefined) {
        	CategoriesService.model.nflowRoleMemberships = this.model.nflowRoleMemberships = [];
        }
        ...
        self.onSave = function () {
            ...
            model.nflowRoleMemberships = self.editModel.nflowRoleMemberships;
            model.owner = self.editModel.owner;
            EntityAccessControlService.updateRoleMembershipsForSave(model.roleMemberships);
            EntityAccessControlService.updateRoleMembershipsForSave(model.nflowRoleMemberships);
    ...
    angular.module(moduleName).directive("onescorpinCategoryAccessControl", directive);
});
