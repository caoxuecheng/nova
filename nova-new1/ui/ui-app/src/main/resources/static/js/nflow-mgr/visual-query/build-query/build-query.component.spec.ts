...
describe("Component: BuildQueryComponent", function () {
    ...
    beforeEach((mocks as angular.IMockStatic).module("nova", "nova.nflowmgr", moduleName));
    ...
    beforeEach((mocks as angular.IMockStatic).inject(function ($injector: angular.auto.IInjectorService) {
        ...
        this.controller = ($injector.get("$componentController") as angular.IComponentControllerService)("onescorpinVisualQueryBuilder", {$scope: $scope}, {engine: engine, model: {}});
