define(['angular','side-nav/module-name', 'constants/AccessConstants', 'side-nav/module','nova-services'], function (angular,moduleName,AccessConstants) {
    ...
    var directive = function ($mdSidenav, $mdDialog,$rootScope,$transitions,$timeout, SideNavService, AccessControlService, StateService,AccordionMenuService, AngularModuleExtensionService) {
        return {
            ...
            link: function ($scope,$element) {
                ...
                $scope.nflowManagerTitle = "Nflow Manager";
                ...
                /**
                 * Array of the top level accordion toggle menu items (i.e. Nflow Manager, Operations, Admin)
                 * @type {Array}
                 */
                var toggleSections = [];
                ...
                var MENU_KEY = {"OPS_MGR":"OPS_MGR","NFLOW_MGR":"NFLOW_MGR","ADMIN":"ADMIN"}
                ...
                /**
                 * Build the Nflow Manager Left Nav
                 * @param allowed
                 */
                function buildNflowManagerMenu() {
                    var menu = ({type:'toggle', text: "Nflow Manager",narrowText:'Nflow',expanded:true,elementId:'toggle_nflow_manager'});
                    var links = [];
                    links.push({sref: "nflows",type:'link', icon: "linear_scale", text: "Nflows", permission: AccessConstants.UI_STATES.NFLOWS.permissions});
                    ...
                    addExtensionLinks(MENU_KEY.NFLOW_MGR, links);
                    menu.links = links;
                    menuMap[MENU_KEY.NFLOW_MGR] = menu;
                 return menu;
                ...
                function buildAdminMenu() {
                    ...
                    links.push({sref: "domain-types", type: "link", icon: "local_offer", text: "Domain Types", defaultActive: false, permission: AccessControlService.NFLOWS_ADMIN});
                ...
                function buildSideNavMenu() {
                    ...
                    menu.push(buildNflowManagerMenu());
                ...
                function menuToggleItemForModuleName(moduleName){
                    ...
                    else if(moduleName.indexOf('nflowmgr') >=0 && moduleName != 'nova.nflowmgr.datasources' && moduleName != "nova.nflowmgr.domain-types" && moduleName != 'nova.nflowmgr.templates'){
                        return menuMap[MENU_KEY.NFLOW_MGR];
                    }
                    else if(moduleName.indexOf('auth') >=0 || moduleName == 'nova.nflowmgr.datasources' || moduleName == "nova.nflowmgr.domain-types" || moduleName == 'nova.nflowmgr.templates'){
    ...
    angular.module(moduleName).directive('novaSideNav', ['$mdSidenav','$mdDialog','$rootScope','$transitions','$timeout','SideNavService','AccessControlService','StateService','AccordionMenuService','AngularModuleExtensionService', directive]);
});
