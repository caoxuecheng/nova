define(['angular',"nflow-mgr/module-name"], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/nflow-mgr/shared/policy-input-form/policy-input-form.html',
    ...
    var controller = function ($scope, $q, PolicyInputFormService) {
        ...
        if(self.onPropertyChange != undefined && angular.isFunction(self.onPropertyChange)) {
            _.each(self.rule.properties, function (property) {
                if ((property.type == 'select' || property.type =='nflowSelect' || property.type == 'currentNflow') && property.value != null) {
                    self.onPropertyChange()(property);
                }
            });
        }
    ...
    angular.module(moduleName)
        .directive('onescorpinPolicyInputForm', directive);
