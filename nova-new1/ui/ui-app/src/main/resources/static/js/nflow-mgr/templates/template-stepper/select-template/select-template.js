define(['angular',"nflow-mgr/templates/module-name"], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            restrict: "EA",
            require: ['onescorpinRegisterSelectTemplate', '^onescorpinStepper'],
            bindToController: {
                stepIndex: '@',
                nifiTemplateId:'=?',
            ...
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/nflow-mgr/templates/template-stepper/select-template/select-template.html',
    ...
    var controller = function ($scope, $http, $mdDialog, $mdToast, $timeout, $q,RestUrlService, RegisterTemplateService, StateService, AccessControlService, EntityAccessControlService,
        ...
        /**
         * The possible options to choose how this template should be displayed in the Nflow Stepper
        ...
        this.confirmDeleteTemplate = function () {
            ...
            $mdDialog.show({
                ...
                scope: $dialogScope,
                templateUrl: "js/nflow-mgr/templates/template-stepper/select-template/template-delete-dialog.html"
            });
        };
    ...
    angular.module(moduleName)
        .directive('onescorpinRegisterSelectTemplate', directive);
