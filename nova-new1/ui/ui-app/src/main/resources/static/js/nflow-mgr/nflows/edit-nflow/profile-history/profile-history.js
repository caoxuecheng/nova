define(['angular','nflow-mgr/nflows/edit-nflow/module-name'], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/nflow-mgr/nflows/edit-nflow/profile-history/profile-history.html',
            controller: "NflowProfileHistoryController",
    ...
    var controller =  function($scope,$http,$mdDialog, $filter, NflowService, RestUrlService, HiveService, StateService, Utils) {
        ...
        function getProfileHistory(){
            ...
            var promise = $http.get(RestUrlService.NFLOW_PROFILE_SUMMARY_URL(self.model.id));
        ...
        this.showProfileDialog = function(currentTab,profileRow) {
            $mdDialog.show({
                controller: 'NflowProfileItemController',
                templateUrl: 'js/nflow-mgr/nflows/edit-nflow/profile-history/profile-history-dialog.html',
    ...
    var NflowProfileItemController = function($scope, $mdDialog, $mdToast, $http, StateService,NflowService, BroadcastService, nflow,profileRow,currentTab){
        $scope.nflow = nflow;
    ...
    angular.module(moduleName).controller('NflowProfileItemController',["$scope","$mdDialog","$mdToast","$http","StateService","NflowService","BroadcastService","nflow","profileRow","currentTab",NflowProfileItemController]);
    ...
    angular.module(moduleName).controller('NflowProfileHistoryController', ["$scope","$http","$mdDialog","$filter","NflowService","RestUrlService","HiveService","StateService","Utils",controller]);

    angular.module(moduleName)
        .directive('onescorpinNflowProfileHistory', directive);
