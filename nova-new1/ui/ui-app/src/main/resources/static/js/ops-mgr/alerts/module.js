define(['angular','ops-mgr/alerts/module-name', 'nova-utils/LazyLoadUtil','constants/AccessConstants','nova-common', 'nova-services','nova-opsmgr'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
