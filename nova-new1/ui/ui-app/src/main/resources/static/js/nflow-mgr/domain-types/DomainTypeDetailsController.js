define(["angular", "nflow-mgr/domain-types/module-name"], function (angular, moduleName) {
     ...
     * @constructor
     */
    function DomainTypeDetailsController($mdDialog, $mdToast, $scope, $transition$, DomainTypesService, NflowFieldPolicyRuleService, NflowService, NflowTagService, StateService) {
        var self = this;
        ...
        self.getAllFieldPolicies = function (domainType) {
            return NflowFieldPolicyRuleService.getAllPolicyRules(domainType.fieldPolicy);
        };
        ...
        self.onCancel = function () {
            if (self.isNew()) {
                StateService.NflowManager().DomainType().navigateToDomainTypes();
            }
        };
    ...
    angular.module(moduleName)
        .controller("DomainTypeDetailsController", ["$mdDialog", "$mdToast", "$scope", "$transition$", "DomainTypesService", "NflowFieldPolicyRuleService", "NflowService", "NflowTagService",
