define(['angular', 'nova-common', '@uirouter/angular', 'nova-services',
    ...
    app.config(["$ocLazyLoadProvider", "$stateProvider", "$urlRouterProvider", function ($ocLazyLoadProvider, $stateProvider, $urlRouterProvider) {
        ...
        $ocLazyLoadProvider.config({
            modules: ['nova', 'nova.common', 'nova.services', 'nova.nflowmgr', 'nova.nflowmgr.templates', 'nova.opsmgr'],
            asyncLoader: require,
            debug: false
        });
        ...
        $stateProvider.state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/nflows/module').then(function success(args) {
                    //upon success go back to the state
                    $stateProvider.stateService.go('nflows')
                    return args;
                }, function error(err) {
                    console.log("Error loading nflows ", err);
                    return err;
                });
            }
        }).state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/nflows/define-nflow/module').then(function success(args) {
                    //upon success go back to the state
                    $stateProvider.stateService.go('define-nflow', transition.params())
                    return args;
                }, function error(err) {
                    console.log("Error loading define-nflow ", err);
                    return err;
                });
            }
        }).state({
            ...
            lazyLoad: function (transition, state) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/nflows/edit-nflow/module').then(function success(args) {
                    //upon success go back to the state
                    $stateProvider.stateService.go('nflow-details', transition.params())
                    return args;
                }, function error(err) {
                    console.log("Error loading nflow-details ", err);
                    return err;
                });
            }
        }).state({
            ...
            lazyLoad: function (transition, state) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/nflows/edit-nflow/module').then(function success(args) {
                    //upon success go back to the state
                    $stateProvider.stateService.go('edit-nflow', transition.params())
                    return args;
                }, function error(err) {
                    console.log("Error loading edit-nflow", err);
                    return err;
                });
            }
        })
        ...
        $stateProvider.state({
            ...
            url: '/categories',
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/categories/module').then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state('registered-templates.**', {
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/templates/module').then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/sla/module').then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state({
            ...
            url: '/tables',
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/tables/module').then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/business-metadata/module').then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('nflow-mgr/visual-query/module').then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state({
            name: 'ops-nflow-details.**',
            url: '/ops-nflow-details/{nflowName}',
            params: {
                nflowName: null
            },
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('ops-mgr/nflows/module').then(function success(args) {
                    //upon success go back to the state
                    $stateProvider.stateService.go('ops-nflow-details', transition.params())
                    return args;
                }, function error(err) {
                    console.log("Error loading ops-nflow-details ", err);
                    return err;
                });
            }
        });
        ...
        $stateProvider.state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get('$ocLazyLoad').load('ops-mgr/nflows/nflow-stats/module').then(function success(args) {
                    //upon success go back to the state
                    $stateProvider.stateService.go('nflow-stats', transition.params())
                    return args;
                }, function error(err) {
                    console.log("Error loading nflow-stats ", err);
                    return err;
                });
            }
        });
        ...
        $stateProvider.state({
            ...
            url: "/datasources",
            lazyLoad: function(transition) {
                transition.injector().get("$ocLazyLoad").load("nflow-mgr/datasources/module").then(function success(args) {
                    //upon success go back to the state
        ...
        $stateProvider.state({
            ...
            lazyLoad: function (transition) {
                transition.injector().get("$ocLazyLoad")
                    .load("nflow-mgr/domain-types/module")
                    .then(function (args) {
