define(['angular',"nflow-mgr/templates/module-name"], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/nflow-mgr/templates/template-stepper/processor-properties/processor-properties.html',
    ...
    var controller =  function($scope, $element,$http,$q,$mdToast,$location,$window,RestUrlService, RegisterTemplateService,NflowService, UiComponentsService) {
    ...
    angular.module(moduleName).controller('RegisterProcessorPropertiesController', ["$scope","$element","$http","$q","$mdToast","$location","$window","RestUrlService","RegisterTemplateService","NflowService","UiComponentsService",controller]);

    angular.module(moduleName)
        .directive('onescorpinRegisterProcessorProperties', directive);
