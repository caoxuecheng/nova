define(['angular','ops-mgr/jobs/module-name',  'nova-utils/LazyLoadUtil','constants/AccessConstants','nova-common', 'nova-services', 'nova-opsmgr'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
