define(["require", "exports", "angular", "underscore"], function (require, exports, angular, _) {
    "use strict";
    function NflowService($http, $q, $mdToast, $mdDialog, RestUrlService, VisualQueryService, NflowCreationErrorService, NflowPropertyService, AccessControlService, EntityAccessControlService, StateService) {
        function trim(str) {
        ...
        var data = {
             ...
             * @param nflowModel
             */
            updateNflow: function (nflowModel) {
                var self = this;
            ...
            setTableFields: function (fields, policies) {
                ...
                this.createNflowModel.table.fieldPolicies = (policies != null && policies.length > 0) ? policies : fields.map(function (field) { return _this.newTableFieldPolicy(field.name); });
            },
            /**
             ...
             * return true/false if there is a PK defined for the incoming set of {@code nflowModel.table.tableSchema.fields
                 ...
                 * @returns {boolean}
             */
            hasPrimaryKeyDefined: function (nflowModel) {
                var firstPk = _.find(nflowModel.table.tableSchema.fields, function (field) {
             ...
             * @returns {boolean}
             */
            enableDisablePkMergeStrategy: function (nflowModel, strategies) {
             ...
             */
            enableDisableRollingSyncMergeStrategy: function (nflowModel, strategies) {
             ...
             * @param nflowName
             */
            showNflowSavingDialog: function (ev, message, nflowName) {
                $mdDialog.show({
             ...
             * @returns {HttpPromise}
             */
            getSystemName: function (nflowName) {
            ...
            getColumnDefinitionByName: function (name) {
                return _.find(this.createNflowModel.table.tableSchema.fields, function (columnDef) {
            ...
            getNflowByName: function (nflowName) {
                var deferred = $q.defer();
     ...
     */
    function NflowSavingDialogController($scope, $mdDialog, message, nflowName) {
    ...
    exports.NflowSavingDialogController = NflowSavingDialogController;
...
//# sourceMappingURL=NflowService.js.map
