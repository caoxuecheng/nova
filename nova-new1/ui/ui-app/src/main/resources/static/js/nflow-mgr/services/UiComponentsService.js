 ...
 * @property {(string|null)} nflowDetailsTemplateUrl - the template URL containing sections for viewing or editing a nflow
 ...
 * @property {(string|null)} stepperTemplateUrl - the template URL containing steps for creating or editing a nflow
 * @property {number} totalSteps - the number of additional steps for creating or editing a nflow
