define(['angular',"nflow-mgr/module-name"], function (angular,moduleName) {
    ...
    var directive = function() {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/nflow-mgr/shared/hql-editor/hql-editor.html',
    ...
    var controller = function($scope, $element, $mdDialog, $mdToast, $http, RestUrlService, StateService, HiveService) {
        ...
        this.fullscreen = function() {
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'js/nflow-mgr/shared/hql-editor/hql-editor-fullscreen.html',
    ...
    angular.module(moduleName).directive('onescorpinHqlEditor', directive);
