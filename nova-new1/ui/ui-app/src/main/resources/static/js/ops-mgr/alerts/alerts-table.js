...
//                var start = start + limit;
        ...
        function transformAlert(alert) {
            ...
            if(alert.typeDisplay.indexOf("http://nova.io/alert/alert/") == 0){
                alert.typeDisplay = alert.typeDisplay.substring("http://nova.io/alert/alert/".length);
                alert.typeDisplay= alert.typeDisplay.split("/").join(" ");
            }
            else if(alert.typeDisplay.indexOf("http://nova.io/alert/") == 0){
                alert.typeDisplay = alert.typeDisplay.substring("http://nova.io/alert/".length);
                alert.typeDisplay = alert.typeDisplay.split("/").join(" ");
            }
            return alert;
        }
