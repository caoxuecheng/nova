define(['angular',"nflow-mgr/tables/module-name"], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/nflow-mgr/tables/preview.html',
    ...
    var controller =  function($scope,$http,NflowService, RestUrlService, HiveService) {
    ...
    angular.module(moduleName).controller('PreviewController', ["$scope","$http","NflowService","RestUrlService","HiveService",controller]);
    angular.module(moduleName)
        .directive('onescorpinPreview', directive);
