define(["require", "exports", "angular-mocks", "underscore", "nflow-mgr/visual-query/module", "nflow-mgr/visual-query/module-require"], function (require, exports, mocks, _) {
    "use strict";
    ...
    describe("Component: BuildQueryComponent", function () {
        ...
        beforeEach(mocks.inject(function ($injector) {
            ...
            this.controller = $injector.get("$componentController")("onescorpinVisualQueryBuilder", { $scope: $scope }, { engine: engine, model: {} });
        ...
        it("should produce SQL for one table", function () {
            this.$http.whenGET("js/nflows/nflows-table.html").respond(200, "");
            // Test SQL
