define(['angular',"nflow-mgr/sla/module-name"], function (angular,moduleName) {
    ...
    var controller = function ($transition$, $mdDialog, $mdToast, $http, SlaEmailTemplateService, StateService,AccessControlService) {
        ...
        //redirect back to email template list page
            StateService.NflowManager().Sla().navigateToEmailTemplates();
        }
        ...
        this.exampleTemplate = function(){
            ...
            self.template.template = '<html>\n<body> \n'+
                                     ...
                                     '\t\t\t\t<img src="https://nova.io/assets/Nova-Logo-REV.png" height="50%" width="50%">\n'+
                                     '\t\t\t</td>\n'+
                                     '\t\t</tr>\n'+
                                     '\t\t<tr>\n'+
                                     '\t\t\t<td>\n'+
        ...
        this.navigateToSla=function(slaId){
            StateService.NflowManager().Sla().navigateToServiceLevelAgreement(slaId);
        }
        ...
        function showTestDialog(resolvedTemplate) {
            $mdDialog.show({
                ...
                templateUrl: 'js/nflow-mgr/sla/sla-email-templates/test-velocity-dialog.html',
