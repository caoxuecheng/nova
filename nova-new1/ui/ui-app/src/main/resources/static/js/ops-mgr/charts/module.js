define(['angular','ops-mgr/charts/module-name', 'nova-utils/LazyLoadUtil','constants/AccessConstants','nova-common', 'nova-services','nova-opsmgr','jquery','jquery-ui','pivottable'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
   var module = angular.module(moduleName, []);
    ...
    module.run(['$ocLazyLoad',function($ocLazyLoad){
        $ocLazyLoad.load({name:'nova',files:['bower_components/c3/c3.css',
