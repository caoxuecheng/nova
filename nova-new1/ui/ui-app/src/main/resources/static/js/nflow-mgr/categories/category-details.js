        ...
        self.onLoad = function () {
            if (angular.isString($transition$.params().categoryId)) {
                ...
                if(angular.isDefined(CategoriesService.model)) {
                    CategoriesService.model.loadingRelatedNflows = true;
                    CategoriesService.populateRelatedNflows(CategoriesService.model).then(function(category){
                        category.loadingRelatedNflows = false;
                    });
                }
