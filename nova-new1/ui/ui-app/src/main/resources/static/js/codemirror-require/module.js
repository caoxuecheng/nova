define(['angular','codemirror-require/module-name','nova-utils/LazyLoadUtil', 'codemirror', 'angular-ui-codemirror'], function (angular,moduleName,lazyLoadUtil,CodeMirror) {
    window.CodeMirror = CodeMirror;
    var module = angular.module(moduleName, []);

    module.run(['$ocLazyLoad',function($ocLazyLoad){
        $ocLazyLoad.load({name:'nova',files:[
