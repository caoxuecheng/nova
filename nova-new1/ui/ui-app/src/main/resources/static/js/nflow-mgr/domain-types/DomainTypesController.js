define(["angular", "nflow-mgr/domain-types/module-name"], function (angular, moduleName) {
     ...
     * @constructor
     */
    function DomainTypesController(AddButtonService, DomainTypesService, NflowFieldPolicyRuleService, StateService) {
        var self = this;
        ...
        self.editDomainType = function (domainType) {
            StateService.NflowManager().DomainType().navigateToDomainTypeDetails(domainType.id);
        };
        ...
        self.getAllFieldPolicies = function (domainType) {
            var rules = NflowFieldPolicyRuleService.getAllPolicyRules(domainType.fieldPolicy);
        ...
        AddButtonService.registerAddButton(PAGE_NAME, function () {
            StateService.NflowManager().DomainType().navigateToDomainTypeDetails();
        });
    ...
    angular.module(moduleName).controller("DomainTypesController", ["AddButtonService", "DomainTypesService", "NflowFieldPolicyRuleService", "StateService", DomainTypesController]);
});
