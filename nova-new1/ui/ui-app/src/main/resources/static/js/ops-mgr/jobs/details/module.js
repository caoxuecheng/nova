define(['angular','ops-mgr/jobs/details/module-name', 'nova-utils/LazyLoadUtil','constants/AccessConstants', 'nova-common', 'nova-services','nova-opsmgr','ops-mgr/jobs/module'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
