define(['angular','ops-mgr/overview/module-name', 'nova-utils/LazyLoadUtil','constants/AccessConstants','nova-common', 'nova-services','nova-opsmgr','angular-nvd3','ops-mgr/alerts/module'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
