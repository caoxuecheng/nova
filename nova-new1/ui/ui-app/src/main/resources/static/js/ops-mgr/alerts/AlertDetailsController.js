            ...
            if(alertId) {
                $http.get(OpsManagerRestUrlService.ALERT_DETAILS_URL(alertId))
                    .then(function (response) {
                        ...
                        if(self.alertData.type == 'http://nova.io/alert/job/failure') {
                            ...
                            self.alertData.links.push({label:"Nflow Details",  value:"ops-nflow-details({nflowName:'"+self.alertData.entityId+"'})"});

                        }
                        else   if(self.alertData.type == 'http://nova.io/alert/alert/sla/violation') {
                        ...
                        else   if(self.alertData.type == 'http://nova.io/alert/service') {
