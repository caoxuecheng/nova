define(['angular', 'admin/module-name','nova-utils/LazyLoadUtil','constants/AccessConstants','codemirror-require/module','nova-common', 'nova-services','jquery'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
    ...
    module.run(['$ocLazyLoad', function ($ocLazyLoad) {
        $ocLazyLoad.load({
            name: 'nova', files: ['bower_components/angular-ui-grid/ui-grid.css', 'assets/ui-grid-material.css'
            ], serie: true
        })
    }]);
    return module;
