    ...
    function DatasourcesDetailsController($scope, $mdDialog, $mdToast, $q, $transition$, AccessControlService, DatasourcesService, EntityAccessControlService, StateService) {
        ...
        self.onCancel = function () {
            if (!angular.isString(self.model.id)) {
                StateService.NflowManager().Datasource().navigateToDatasources();
            }
        };
        ...
        self.onDelete = function () {
            if (!angular.isArray(self.model.sourceForNflows) || self.model.sourceForNflows.length === 0) {
                ...
                $mdDialog.show(
                    $mdDialog.alert()
                        .clickOutsideToClose(true)
                        .title("Delete Failed")
                        .textContent("This data source is currently being used by " + self.model.sourceForNflows.length + " nflow(s).")
                        .ariaLabel("Failed to delete data source")
                        .ok("Got it!")
                );
            }
        ...
        self.onDetailsSave = function () {
            ...
            $mdDialog.show({
                ...
                templateUrl: 'js/nflow-mgr/datasources/datasource-saving-dialog.html',
