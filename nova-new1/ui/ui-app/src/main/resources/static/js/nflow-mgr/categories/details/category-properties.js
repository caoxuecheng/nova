define(['angular', 'nflow-mgr/categories/module-name'], function (angular, moduleName) {
     ...
     */
    function onescorpinCategoryProperties() {
        return {
            controller: "CategoryPropertiesController",
            controllerAs: 'vm',
            restrict: "E",
            scope: {},
            templateUrl: "js/nflow-mgr/categories/details/category-properties.html"
        };
    }
    ...
    angular.module(moduleName).directive("onescorpinCategoryProperties", onescorpinCategoryProperties);
