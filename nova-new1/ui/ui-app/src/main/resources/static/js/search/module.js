define(['angular','search/module-name','nova-utils/LazyLoadUtil','constants/AccessConstants', 'nova-services','nova-nflowmgr'], function (angular,moduleName,lazyLoadUtil,AccessConstants) {
