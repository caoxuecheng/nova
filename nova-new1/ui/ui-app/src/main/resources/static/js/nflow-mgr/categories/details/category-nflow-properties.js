define(['angular', 'nflow-mgr/categories/module-name'], function (angular, moduleName) {
    /**
     * Manages the Category Nflow Properties section of the Category Details page.
     *
     * @constructor
     ...
     */
    function CategoryNflowPropertiesController($scope, $mdToast, $q, AccessControlService, EntityAccessControlService, CategoriesService) {
        var self = this;
    ...
    /**
     * Creates a directive for the Category Nflow Properties section.
     *
     * @returns {Object} the directive
     */
    function onescorpinNflowCategoryProperties() {
        return {
            controller: "CategoryNflowPropertiesController",
            controllerAs: 'vm',
            restrict: "E",
            scope: {},
            templateUrl: 'js/nflow-mgr/categories/details/category-nflow-properties.html'
        };
    }

    angular.module(moduleName).controller('CategoryNflowPropertiesController',
        ["$scope", "$mdToast", "$q", "AccessControlService", "EntityAccessControlService", "CategoriesService", CategoryNflowPropertiesController]);
    angular.module(moduleName).directive('onescorpinCategoryNflowProperties', onescorpinNflowCategoryProperties);
});
