define(['angular',"nflow-mgr/templates/module-name"], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/nflow-mgr/templates/template-stepper/access-control/template-access-control.html',
    ...
    angular.module(moduleName).directive("onescorpinTemplateAccessControl", directive);
});
