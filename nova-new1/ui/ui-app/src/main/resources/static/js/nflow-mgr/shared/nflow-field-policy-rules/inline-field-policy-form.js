define(['angular',"nflow-mgr/module-name"], function (angular,moduleName) {
    ...
    var directive = function (FieldPolicyRuleOptionsFactory, PolicyInputFormService) {
        return {
            ...
            templateUrl: 'js/nflow-mgr/shared/nflow-field-policy-rules/inline-field-policy-form.html',
            link: function ($scope, element, attrs) {
                ...
                FieldPolicyRuleOptionsFactory.getOptionsForType($scope.policyParameter).then(function (response) {
                    ...
                    $scope.options = PolicyInputFormService.groupPolicyOptions(results, currentNflowValue);
                    ruleTypesAvailable();
