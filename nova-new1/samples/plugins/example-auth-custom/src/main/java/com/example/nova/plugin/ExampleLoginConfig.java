 ...
 * a Nova plugin.  Its purpose is to define a bean representing a login module configuration
 * using the builder provided by the Nova authentication framework.
 */
@Configuration
public class ExampleLoginConfig {
    ...
    public LoginConfiguration servicesLdapLoginConfiguration(LoginConfigurationBuilder builder) {
        ...
        // This uses the same LoginModule and settings in the authentication process of both the Nova UI and Nova services.
        return builder
