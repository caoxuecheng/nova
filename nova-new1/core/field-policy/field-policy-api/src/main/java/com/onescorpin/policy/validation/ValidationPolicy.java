 ...
 * The class should be annotated with a {@link Validator} and any fields needed to be captured by the end user should be annotated with the {@link com.onescorpin.policy.PolicyProperty}
 *
