package com.onescorpin.metadata.jpa.jobrepo.step;
...
import com.onescorpin.metadata.api.jobrepo.step.BatchStepExecutionContextValue;
import com.onescorpin.metadata.jpa.jobrepo.AbstractBatchExecutionContextValue;
...
public class JpaBatchStepExecutionContextValue extends AbstractBatchExecutionContextValue implements BatchStepExecutionContextValue {
    ...
    @Type(type = "com.onescorpin.jpa.TruncateStringUserType", parameters = {@Parameter(name = "length", value = "250")})
