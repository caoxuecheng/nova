 ...
 *
 */
package com.onescorpin.metadata.jpa.alerts;
...
import com.onescorpin.jpa.AuditTimestampListener;
import com.onescorpin.jpa.AuditedEntity;
import com.onescorpin.jpa.BaseJpaId;
import com.onescorpin.jpa.JsonAttributeConverter;
...
/**
 * Implements the JPA-based alert type managed in the Nova alert store.
 */
@Entity
@Table(name = "NOVA_ALERT")
...
public class JpaAlert implements EntityAlert, AuditedEntity {
    ...
    @CollectionTable(name = "NOVA_ALERT_CHANGE", joinColumns = @JoinColumn(name = "ALERT_ID"))
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getId()
     */
    @Override
    public ID getId() {
        return this.id;
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getType()
     */
    @Override
    public URI getType() {
    ...
    /* (non-Javadoc)
             * @see com.onescorpin.alerts.api.Alert#getDescription()
             */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getLevel()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getCurrentState()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getCreatedTime()
     */
    @Override
    ...
    /* (non-Javadoc)
         * @see com.onescorpin.alerts.api.Alert#getSource()
         */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#isCleared()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#isActionable()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getEvents()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.Alert#getContent()
     */
    @Override
