...
import com.onescorpin.metadata.jpa.alerts.JpaAlert.AlertContentConverter;
...
public class JpaAlertChangeEvent implements AlertChangeEvent, Comparable<AlertChangeEvent> {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertChangeEvent#getChangeTime()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertChangeEvent#getUser()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertChangeEvent#getState()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertChangeEvent#getDescription()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertChangeEvent#getContent()
     */
    @Override
