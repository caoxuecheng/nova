...
import com.onescorpin.metadata.api.jobrepo.nifi.NifiEvent;
import com.onescorpin.metadata.api.jobrepo.nifi.NifiRelatedRootFlowFiles;
...
/**
 * Entity to store any Nflow Flow files that are related to each other.
 ...
 *
 * @see com.onescorpin.metadata.jpa.jobrepo.job.JpaBatchJobExecutionProvider#checkAndRelateJobs(ProvenanceEventRecordDTO, NifiEvent)
 */
@Entity
