...
import com.onescorpin.metadata.jpa.nflow.AugmentableQueryRepositoryFactoryBean;
...
import com.onescorpin.metadata.jpa.jobrepo.job.JobExecutionChangedNotifier;
import com.onescorpin.metadata.jpa.sla.JpaServiceLevelAssessor;
...
@EnableJpaRepositories(
    basePackages = {"com.onescorpin.metadata.jpa", "com.onescorpin.metadata.jpa.nflow.security"},
...
public class OperationalMetadataConfig {
    ...
    public EntityManagerFactory entityManagerFactory(@Qualifier("dataSource") DataSource dataSource) {
        ...
        emfBean.setPackagesToScan("com.onescorpin.jobrepo.jpa", "com.onescorpin.metadata.jpa");
    ...
    @Bean
    public OpsManagerNflowCacheByName opsManagerNflowCacheByName() {
        return new OpsManagerNflowCacheByName();
    }

    @Bean
    public OpsManagerNflowCacheById opsManagerNflowCacheById() {
        return new OpsManagerNflowCacheById();
    }

    @Bean
    public NflowAclCache nflowAclCache(){
        return new NflowAclCache();
    }
