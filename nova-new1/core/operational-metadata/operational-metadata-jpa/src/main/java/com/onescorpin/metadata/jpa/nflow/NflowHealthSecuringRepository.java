 ...
 */
public class NflowHealthSecuringRepository extends AugmentableQueryRepositoryImpl {

    public NflowHealthSecuringRepository(JpaEntityInformation entityInformation, EntityManager em) {
