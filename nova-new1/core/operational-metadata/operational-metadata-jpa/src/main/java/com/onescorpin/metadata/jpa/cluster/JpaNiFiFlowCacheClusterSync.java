package com.onescorpin.metadata.jpa.cluster;
...
import com.onescorpin.metadata.api.cluster.NiFiFlowCacheClusterSync;
...
public class JpaNiFiFlowCacheClusterSync implements NiFiFlowCacheClusterSync {
    ...
    @Column(name = "NOVA_CLUSTER_ADDRESS",insertable = false,updatable = false)
    ...
    public static class NiFiFlowCacheKey implements Serializable {
        ...
        @Column(name = "NOVA_CLUSTER_ADDRESS")
        private String clusterAddress;
