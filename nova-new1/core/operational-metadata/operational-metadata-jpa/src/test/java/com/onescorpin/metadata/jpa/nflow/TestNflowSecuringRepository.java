 ...
 */
public class TestNflowSecuringRepository extends AugmentableQueryRepositoryImpl {

    private static final Logger LOG = LoggerFactory.getLogger(TestNflowSecuringRepository.class);

    public TestNflowSecuringRepository(JpaEntityInformation entityInformation, EntityManager em) {
        super(entityInformation, em);
        this.setAugmentor(new NflowSecuringQueryAugmentor());
    }

    public List<JpaOpsManagerNflow> findByName(String name) {
        LOG.debug("TestNflowSecuringRepository.findByName");
