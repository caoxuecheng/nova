...
/**
 * Represents high level flow and job statistics for a given nflow and processor
 */
public interface NifiNflowProcessorStats {
    ...
    /**
     * Return  the unique id  for this nflow processor statistic entry
     *
     * @return the unique id  for this nflow processor statistic entry
     */
    String getId();
    ...
    /**
     * Return the nflow process group id
     *
     * @return the nflow process group id
     */
    String getNflowProcessGroupId();

    /**
     * Set the nflow process group id
     */
    void setNflowProcessGroupId(String nflowProcessGroupId);
    ...
    /**
     * Return the sum of the duration in millis of events for this nflow/processor during its collection
     *
     * @return the sum of the duration in millis of events for this nflow/processor during its collection
     */
    Long getDuration();
    ...
    /**
     * return the total bytes taken in by this nflow and processor
     *
     * @return the total bytes taken in by this nflow and processor
     */
    Long getBytesIn();
    ...
    /**
     * return the total bytes out by this nflow and processor
     *
     * @return the total bytes out by this nflow and processor
     */
    Long getBytesOut();
    ...
    /**
     * return the total events for this nflow and processor
     *
     * @return the total events for  this nflow and processor
     */
    Long getTotalCount();
    ...
    /**
     * return the total jobs started by this nflow and processor
     *
     * @return the total jobs started by this nflow and processor
     */
    Long getJobsStarted();
    ...
    /**
     * return the total jobs finished by this nflow and processor
     *
     * @return the total jobs finished by this nflow and processor
     */
    ...
    /**
     * return the total jobs failed by this nflow and processor
     *
     * @return the total jobs failed by this nflow and processor
     */
    Long getJobsFailed();
    ...
    /**
     * return the total job duration in millis for this nflow and processor
     *
     * @return the total job duration in millis for this nflow and processor
     */
    Long getJobDuration();
    ...
    /**
     * return the successful job duration in millis for this nflow and processor
     *
     * @return the total ob duration in millis this nflow and processor
     */
    ...
    /**
     * return the total processors failed by this nflow and processor
     *
     * @return the total processors failed by this nflow and processor
     */
    ...
    /**
     * return the total flow files started by this nflow and processor
     *
     * @return the total flow files started  by this nflow and processor
     */
    ...
    /**
     * return the total flow files finished by this nflow and processor
     *
     * @return the total flow files finished  by this nflow and processor
     */
    ...
    /**
     * return the minimum event time for this nflow and processor
     *
     * @return the minimum event time for this nflow and processor
     */
    ...
    /**
     * return the maximum event time for this nflow and processor
     *
     * @return the maximum event time for this nflow and processor
     */
    ...
    /**
     * return the maximum event id for this nflow and processor
     *
     * @return the maximum event id for this nflow and processor
     */
    Long getMaxEventId();
