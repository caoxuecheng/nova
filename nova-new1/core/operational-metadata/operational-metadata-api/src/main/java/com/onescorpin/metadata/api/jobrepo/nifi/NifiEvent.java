...
/**
 * Represents information about the NiFi Provenance event taken from the {@link com.onescorpin.nifi.provenance.model.ProvenanceEventRecordDTO}
 */
@Deprecated
public interface NifiEvent {
    ...
    /**
     * Return the process group id for the nflow that this event partakes in
     */
