...
/**
 * Represents the latest {@link BatchJobExecution} for a nflow
 * This object holds most of the data related to the latest job execution id for the nflow.
 ...
 */
public interface LatestNflowJobExecution {
    ...
    /**
     * Return the latest job execution.  This can be accessed to get additional information about the nflow.
     *
