package com.onescorpin.kerberos;

/*-
 * #%L
 * onescorpin-kerberos-test-client
 * %%
...
public class TestKerberosKinit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(" ");
        System.out.println("Hit enter to default to: /etc/security/keytabs/hive-onescorpin.headless.keytab");
        System.out.print("Please enter the keytab file location: ");
        String keytab = scanner.nextLine();
        if (StringUtils.isEmpty(keytab)) {
            keytab = "/etc/security/keytabs/hive-onescorpin.headless.keytab";
        }
