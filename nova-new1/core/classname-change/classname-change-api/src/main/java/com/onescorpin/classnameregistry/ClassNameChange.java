package com.onescorpin.classnameregistry;

/*-
 * #%L
 * onescorpin-classname-change-api
 * %%
...
/**
 * Classes that are stored in the Nova metadata may change their package name or class name over time. If these objects, especially those stored as JSON objects in our metadata store change their
 ...
 *
 * package com.onescorpin.data
 *
 * @ClassNameChange(classNames = {"com.onescorpin.old.pkg.MyClass"}) public class MyNewClas { ...}
 */
