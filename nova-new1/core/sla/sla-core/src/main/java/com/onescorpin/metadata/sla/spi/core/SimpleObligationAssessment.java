...
public class SimpleObligationAssessment implements ObligationAssessment {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.sla.api.ObligationAssessment#getObligation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.sla.api.ObligationAssessment#getMessage()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.sla.api.ObligationAssessment#getResult()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.metadata.sla.api.ObligationAssessment#getMetricAssessments()
     */
    @Override
