...
import com.onescorpin.metadata.sla.spi.AssessorNotFoundException;
import com.onescorpin.metadata.sla.spi.MetricAssessmentBuilder;
import com.onescorpin.metadata.sla.spi.MetricAssessor;
import com.onescorpin.metadata.sla.spi.ObligationAssessmentBuilder;
import com.onescorpin.metadata.sla.spi.ObligationAssessor;
...
public class SimpleServiceLevelAssessor implements ServiceLevelAssessor {
     ...
     * 
     * @see
     * com.onescorpin.metadata.sla.spi.ServiceLevelAssessor#assess(com.
     * onescorpin.metadata.sla.api.ServiceLevelAgreement)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.onescorpin.metadata.sla.spi.ServiceLevelAssessor#
     * registerObligationAssessor(com.onescorpin.metadata.sla.spi.
     * ObligationAssessor)
     */
    @Override
     ...
     * 
     * @see com.onescorpin.metadata.sla.spi.ServiceLevelAssessor#
     * registerMetricAssessor(com.onescorpin.metadata.sla.spi.
     * MetricAssessor)
     */
    @Override
