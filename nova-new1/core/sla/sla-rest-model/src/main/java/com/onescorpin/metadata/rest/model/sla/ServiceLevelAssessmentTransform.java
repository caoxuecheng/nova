...
public class ServiceLevelAssessmentTransform {
    ...
    public static ServiceLevelAssessment toModel(com.onescorpin.metadata.sla.api.ServiceLevelAssessment assessment){
    ...
    private static ObligationAssessment  toModel(com.onescorpin.metadata.sla.api.ObligationAssessment obligationAssessment){
    ...
    private static MetricAssessment toModel(com.onescorpin.metadata.sla.api.MetricAssessment metricAssessment){
