...
/*-
 * #%L
 * onescorpin-service-monitor-api
 * %%
...
/**
 * Marker interface to perform Service Status verification in the Nova Operations Manager.
 * Any classes with this interface will be automatically wired in and checked for Service Health in Nova.
 *
