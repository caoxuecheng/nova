...
/**
 * Represents a Batch Job Execution along with some additional information that is transformed from the domain model {@link com.onescorpin.metadata.api.jobrepo.job.BatchJobExecution}
 */
public interface ExecutedJob {
     ...
     *
     * @see com.onescorpin.metadata.api.jobrepo.ExecutionConstants.ExitCode
     */
    String getExitCode();
    ...
    /**
     * Return the job type. 2 supported types (CHECK, or NFLOW).
     *
     * @return the type of job
     * @see com.onescorpin.jobrepo.common.constants.NflowConstants  for more information on the types of jobs
     */
    String getJobType();
    ...
    /**
     * Return the nflow name associated with this job
     *
     * @return the nflow associated with this job
     */
    String getNflowName();

    /**
     * set the nflow name associated with this job
     */
    ...
    /**
     * Return the nflow id associated with this job
     *
     * @return the nflowId associated with this job
     */
    String getNflowId();

    /**
     * set the nflow id associated with this job
     */
