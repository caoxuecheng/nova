...
/**
 * Represents a Batch Job Execution in the context of a Nflow
 */
public interface ExecutedNflow {
    ...
    /**
     * Return the nflow job instance id
     *
     * @return the job instance id for this nflow/job execution
     */
    Long getNflowInstanceId();

    /**
     * set the nflow job instance id
     */
    void setNflowInstanceId(Long nflowInstanceId);

    /**
     * Return the nflow job execution id
     *
     * @return the job execution id
     */
    Long getNflowExecutionId();

    /**
     * set the nflow job execution id
     */
    void setNflowExecutionId(Long nflowExecutionId);
