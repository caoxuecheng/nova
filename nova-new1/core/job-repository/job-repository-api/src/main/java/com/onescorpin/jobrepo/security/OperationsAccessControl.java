 ...
 *
 */
package com.onescorpin.jobrepo.security;
...
/**
 * Describes the permissible actions related to operational services (nflow processing management,
...
public interface OperationsAccessControl {
    ...
    Action ACCESS_OPS = Action.create("accessOperations",
                                      ...
                                      "Allows access to operational information like active nflows, execution history, job and nflow stats, health status, etc.");
