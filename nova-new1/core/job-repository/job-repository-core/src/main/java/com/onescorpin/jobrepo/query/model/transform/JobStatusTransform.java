...
import com.onescorpin.jobrepo.query.model.JobStatusCountResult;
...
public class JobStatusTransform {
    ...
    public static JobStatusCount jobStatusCount(com.onescorpin.metadata.api.jobrepo.job.JobStatusCount domain) {
        ...
        count.setNflowName(domain.getNflowName());
        count.setNflowId(domain.getNflowId());
