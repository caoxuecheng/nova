...
/**
 * Stores the search results coming from a type unknown to Nova
 */
//This can happen if the index is not known to Nova
public class UnknownTypeSearchResultData extends AbstractSearchResultData {
    ...
    public UnknownTypeSearchResultData() {
        ...
        super.setType(SearchResultType.NOVA_UNKNOWN);
    }
}
