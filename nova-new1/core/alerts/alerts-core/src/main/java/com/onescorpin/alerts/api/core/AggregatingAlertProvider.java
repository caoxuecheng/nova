 ...
 *
 */
package com.onescorpin.alerts.api.core;

/*-
 * #%L
 * onescorpin-alerts-core
 * %%
...
import com.onescorpin.alerts.api.Alert.ID;
import com.onescorpin.alerts.api.AlertCriteria;
import com.onescorpin.alerts.api.AlertListener;
...
import com.onescorpin.alerts.spi.AlertSourceAggregator;
...
public class AggregatingAlertProvider implements AlertProvider, AlertSourceAggregator, AlertNotifyReceiver, Consumer<Event<Alert>> {
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#criteria()
     */
    @Override
    ...
    /* (non-Javadoc)
         * @see com.onescorpin.alerts.api.AlertProvider#addListener(com.onescorpin.alerts.api.AlertListener)
         */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#addResponder(com.onescorpin.alerts.api.AlertResponder)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.spi.AlertSourceAggregator#addAlertSource(com.onescorpin.alerts.spi.AlertSource)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.spi.AlertSourceAggregator#removeAlertSource(com.onescorpin.alerts.spi.AlertSource)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.spi.AlertSourceAggregator#removeAlertManager(com.onescorpin.alerts.spi.AlertManager)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#getAlert(com.onescorpin.alerts.api.Alert.ID)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#getAlerts(com.onescorpin.alerts.api.AlertCriteria)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#getAlerts(org.joda.time.DateTime)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#getAlertsBefore(org.joda.time.DateTime)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.onescorpin.alerts.api.AlertProvider#respondTo(com.onescorpin.alerts.api.Alert.ID, com.onescorpin.alerts.api.AlertResponder)
     */
    @Override
